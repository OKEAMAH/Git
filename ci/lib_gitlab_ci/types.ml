...
(* Note:
   ...
   A job_rule has the following elements:
   ...
   A workflow rule has the following elements:

     if_ : If.t option;
     changes : string list option;
     when_ : of type workflow_when
     variables : variables option;

   An include rule has the following elements:

     if_ : If.t option;
     changes : string list option;
     when_ : of type when_workflow *)
