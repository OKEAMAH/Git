...
val ci_commit_branch : If.term

(** Corresponds to [CI_COMMIT_TAG].*)
val ci_commit_tag : If.term

(** Corresponds to [CI_DEFAULT_BRANCH].*)
val ci_default_branch : If.term

(** Corresponds to [CI_OPEN_MERGE_REQUESTS].*)
val ci_open_merge_requests : If.term

(** Corresponds to [CI_MERGE_REQUEST_ID].*)
val ci_merge_request_id : If.term

(** Corresponds to [CI_PIPELINE_SOURCE].*)
val ci_pipeline_source : If.term

(** Corresponds to [CI_PROJECT_NAMESPACE].*)
val ci_project_namespace : If.term

(** Corresponds to [CI_MERGE_REQUEST_ASSIGNEES].*)
val ci_merge_request_assignees : If.term
