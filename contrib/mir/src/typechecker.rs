...
pub enum TcError {
    ...
    #[error(transparent)]
    TypePropertyError(#[from] TypePropertyError),
...
mod typecheck_tests {
    ...
    fn failwith_operation() {
        ...
        assert_eq!(
            ...
            Err(TcError::TypePropertyError(
                TypePropertyError::InvalidTypeProperty(TypeProperty::Packable, Type::Operation)
            ))
        );
    }
    ...
    fn push_map_incomparable() {
        ...
        assert_eq!(
            ...
            Err(TcError::TypePropertyError(
                TypePropertyError::InvalidTypeProperty(
    ...
    fn test_compare_incomparable() {
        ...
        assert_eq!(
            ...
            Err(TcError::TypePropertyError(
                TypePropertyError::InvalidTypeProperty(TypeProperty::Comparable, Type::Operation)
            ))
        );
    }
    ...
    fn test_push_operation_fail() {
        ...
        assert_eq!(
            ...
            Err(TcError::TypePropertyError(
                TypePropertyError::InvalidTypeProperty(TypeProperty::Pushable, Type::Operation)
            ))
        );
    }
    ...
    fn test_non_passable_parameter() {
        ...
        assert_eq!(
            ...
            .typecheck(&mut ctx),
            Err(TcError::TypePropertyError(
                TypePropertyError::InvalidTypeProperty(TypeProperty::Passable, Type::Operation)
            ))
        );
    }
    ...
    fn test_non_storable_storage() {
        ...
        assert_eq!(
            ...
            .typecheck(&mut ctx),
            Err(TcError::TypePropertyError(
                TypePropertyError::InvalidTypeProperty(TypeProperty::Storable, Type::Operation)
            ))
        );
    }
