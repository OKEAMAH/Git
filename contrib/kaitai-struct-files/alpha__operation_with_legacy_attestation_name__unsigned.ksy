...
types:
  ...
  alpha__operation_with_legacy_attestation_name__alpha__contents:
    ...
    - id: vdf_revelation__alpha__operation_with_legacy_attestation_name__alpha__contents
      ...
      if: (alpha__operation_with_legacy_attestation_name__alpha__contents_tag == ::alpha__operation_with_legacy_attestation_name__alpha__contents_tag::alpha__operation_with_legacy_attestation_name__alpha__contents_tag::vdf_revelation)
    ...
    - id: failing_noop__alpha__operation_with_legacy_attestation_name__alpha__contents
      ...
      if: (alpha__operation_with_legacy_attestation_name__alpha__contents_tag == ::alpha__operation_with_legacy_attestation_name__alpha__contents_tag::alpha__operation_with_legacy_attestation_name__alpha__contents_tag::failing_noop)
  ...
  double_endorsement_evidence__op2:
    ...
    - id: len_op2
      ...
      valid:
        max: 1073741823
    - id: op2
      type: double_endorsement_evidence__alpha__inlined__endorsement
      size: len_op2
  double_endorsement_evidence__op1:
    ...
    - id: op1
      type: double_endorsement_evidence__alpha__inlined__endorsement
      size: len_op1
  double_endorsement_evidence__alpha__inlined__endorsement:
    seq:
    - id: operation__shell_header
      size: 32
      doc: An operation's shell header.
    - id: operations
      type: double_endorsement_evidence__alpha__inlined__endorsement_mempool__contents
    - id: signature_tag
      type: u1
      enum: bool
    - id: signature
  ...
  double_endorsement_evidence__alpha__inlined__endorsement_mempool__contents:
    seq:
  ...
  double_preendorsement_evidence__op2:
    ...
    - id: len_op2
      ...
      valid:
        max: 1073741823
    - id: op2
      type: double_preendorsement_evidence__alpha__inlined__preendorsement
      size: len_op2
  double_preendorsement_evidence__op1:
    ...
    - id: op1
      type: double_preendorsement_evidence__alpha__inlined__preendorsement
      size: len_op1
  double_preendorsement_evidence__alpha__inlined__preendorsement:
    seq:
    - id: operation__shell_header
      size: 32
      doc: An operation's shell header.
    - id: operations
      type: double_preendorsement_evidence__alpha__inlined__preendorsement__contents
    - id: signature_tag
      type: u1
      enum: bool
    - id: signature
      size-eos: true
      if: (signature_tag == bool::true)
  double_preendorsement_evidence__alpha__inlined__preendorsement__contents:
    seq:
