...
types:
  ...
  event__id_017__ptnairob__apply_internal_results__alpha__operation_result:
    ...
    - id: tag_tag
      ...
      enum: bool
    - id: tag
      type: event__id_017__ptnairob__entrypoint
  ...
  event__id_017__ptnairob__entrypoint:
    seq:
  ...
  transaction__id_017__ptnairob__apply_internal_results__alpha__operation_result:
    ...
    - id: amount
      type: n
    - id: destination
      type: transaction__id_017__ptnairob__transaction_destination
      doc: ! >-
        A destination of a transaction: A destination notation compatible with the
        contract notation as given to an RPC or inside scripts. Can be a base58 implicit
        contract hash, a base58 originated contract hash, a base58 originated transaction
  ...
  transaction__named__id_017__ptnairob__entrypoint:
    ...
    - id: named
      ...
      valid:
        max: 31
  transaction__id_017__ptnairob__transaction_destination:
    seq:
