...
types:
  id_007__psdelph1__operation__alpha__contents_and_signature_:
    seq:
    - id: contents
  ...
  contents_entries:
    seq:
    - id: id_007__psdelph1__operation__alpha__contents_
      type: id_007__psdelph1__operation__alpha__contents_
  id_007__psdelph1__operation__alpha__contents_:
    seq:
  ...
  origination__id_007__psdelph1__operation__alpha__contents:
    ...
    - id: delegate
      ...
      doc: A Ed25519, Secp256k1, or P256 public key hash
    - id: script
      type: origination__id_007__psdelph1__scripted__contracts_
  origination__id_007__psdelph1__scripted__contracts_:
    seq:
    - id: code
  ...
  transaction__id_007__psdelph1__operation__alpha__contents:
    ...
    - id: amount
      type: n
    - id: destination
      type: transaction__id_007__psdelph1__contract_id_
      doc: ! >-
  ...
  transaction__parameters_:
    seq:
    - id: entrypoint
      type: transaction__id_007__psdelph1__entrypoint_
  ...
  transaction__named__named_dyn:
    ...
    - id: named
      size-eos: true
  transaction__id_007__psdelph1__contract_id_:
    seq:
  ...
  double_baking_evidence__bh2_dyn:
    seq:
    - id: double_baking_evidence__id_007__psdelph1__block_header__alpha__full_header_
      type: double_baking_evidence__id_007__psdelph1__block_header__alpha__full_header_
  ...
  double_baking_evidence__bh1_dyn:
    ...
    - id: double_baking_evidence__id_007__psdelph1__block_header__alpha__full_header_
      type: double_baking_evidence__id_007__psdelph1__block_header__alpha__full_header_
  double_baking_evidence__id_007__psdelph1__block_header__alpha__full_header_:
    seq:
    - id: id_007__psdelph1__block_header__alpha__full_header
      type: block_header__shell
    - id: double_baking_evidence__id_007__psdelph1__block_header__alpha__signed_contents_
      type: double_baking_evidence__id_007__psdelph1__block_header__alpha__signed_contents_
  double_baking_evidence__id_007__psdelph1__block_header__alpha__signed_contents_:
    seq:
    - id: double_baking_evidence__id_007__psdelph1__block_header__alpha__unsigned_contents_
      type: double_baking_evidence__id_007__psdelph1__block_header__alpha__unsigned_contents_
    - id: signature
      size: 64
  double_baking_evidence__id_007__psdelph1__block_header__alpha__unsigned_contents_:
    seq:
    - id: priority
      type: u2
  ...
  double_endorsement_evidence__op2_dyn:
    seq:
    - id: double_endorsement_evidence__id_007__psdelph1__inlined__endorsement_
      type: double_endorsement_evidence__id_007__psdelph1__inlined__endorsement_
  ...
  double_endorsement_evidence__op1_dyn:
    ...
    - id: double_endorsement_evidence__id_007__psdelph1__inlined__endorsement_
      type: double_endorsement_evidence__id_007__psdelph1__inlined__endorsement_
  double_endorsement_evidence__id_007__psdelph1__inlined__endorsement_:
    seq:
    - id: id_007__psdelph1__inlined__endorsement
      type: operation__shell_header
    - id: operations
      type: double_endorsement_evidence__id_007__psdelph1__inlined__endorsement__contents_
    - id: signature_tag
      type: u1
      enum: bool
    - id: signature
  ...
  double_endorsement_evidence__id_007__psdelph1__inlined__endorsement__contents_:
    seq:
...
enums:
  ...
  id_007__psdelph1__operation__alpha__contents_tag:
    ...
    110: delegation
seq:
- id: id_007__psdelph1__operation__alpha__contents_and_signature_
  type: id_007__psdelph1__operation__alpha__contents_and_signature_
