...
types:
  id_009__psfloren__vote__listings_dyn:
    seq:
...
enums:
  public_key_hash_tag:
    ...
    2: p256
seq:
- id: len_id_009__psfloren__vote__listings_dyn
  type: u4
  valid:
    max: 1073741823
- id: id_009__psfloren__vote__listings_dyn
  type: id_009__psfloren__vote__listings_dyn
  size: len_id_009__psfloren__vote__listings_dyn
