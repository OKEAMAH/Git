...
pub struct AlphaLevel {
    pub _root: SharedType<AlphaLevel>,
    pub _parent: SharedType<AlphaLevel>,
    pub _self: SharedType<Self>,
    level: RefCell<i32>,
    level_position: RefCell<i32>,
    cycle: RefCell<i32>,
    cycle_position: RefCell<i32>,
    expected_commitment: RefCell<AlphaLevel_Bool>,
    _io: RefCell<BytesReader>,
}
impl KStruct for AlphaLevel {
    type Root = AlphaLevel;
    type Parent = AlphaLevel;
 ...
 */
impl AlphaLevel {
    pub fn expected_commitment(&self) -> Ref<AlphaLevel_Bool> {
...
pub enum AlphaLevel_Bool {
    False,
    True,
    Unknown(i64),
}

impl TryFrom<i64> for AlphaLevel_Bool {
    type Error = KError;
    fn try_from(flag: i64) -> KResult<AlphaLevel_Bool> {
        match flag {
            0 => Ok(AlphaLevel_Bool::False),
            255 => Ok(AlphaLevel_Bool::True),
            _ => Ok(AlphaLevel_Bool::Unknown(flag)),
        }
    }
}

impl From<&AlphaLevel_Bool> for i64 {
    fn from(v: &AlphaLevel_Bool) -> Self {
        match *v {
            AlphaLevel_Bool::False => 0,
            AlphaLevel_Bool::True => 255,
            AlphaLevel_Bool::Unknown(v) => v
        }
    }
}

impl Default for AlphaLevel_Bool {
    fn default() -> Self { AlphaLevel_Bool::Unknown(0) }
}
