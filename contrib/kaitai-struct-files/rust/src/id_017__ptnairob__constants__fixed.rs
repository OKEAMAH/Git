...
pub struct Id017PtnairobConstantsFixed {
    ...
    pub smartRollupMaxNumberOfMessagesPerLevel: Box<Id017PtnairobConstantsFixed__N>,
}

impl KaitaiStruct for Id017PtnairobConstantsFixed {
    ...
    fn read<S: KaitaiStream>(&mut self,
        ...
        self.smartRollupMaxNumberOfMessagesPerLevel = Box::new(Id017PtnairobConstantsFixed__N::new(self.stream, self, _root)?);
    }
}
...
#[derive(Default)]
pub struct Id017PtnairobConstantsFixed__N {
    pub n: Vec<Box<Id017PtnairobConstantsFixed__NChunk>>,
}

impl KaitaiStruct for Id017PtnairobConstantsFixed__N {
    fn new<S: KaitaiStream>(stream: &mut S,
                            _parent: &Option<Box<KaitaiStruct>>,
                            _root: &Option<Box<KaitaiStruct>>)
                            -> Result<Self>
    ...
    fn read<S: KaitaiStream>(&mut self,
        ...
        self.n = vec!();
        while {
            let tmpa = Box::new(Id017PtnairobConstantsFixed__NChunk::new(self.stream, self, _root)?);
            self.n.append(tmpa);
            !(!(tmpa.has_more))
        } { }
    }
...
impl Id017PtnairobConstantsFixed__N {
}
#[derive(Default)]
pub struct Id017PtnairobConstantsFixed__NChunk {
    pub hasMore: bool,
    pub payload: u64,
}

impl KaitaiStruct for Id017PtnairobConstantsFixed__NChunk {
    fn new<S: KaitaiStream>(stream: &mut S,
                            _parent: &Option<Box<KaitaiStruct>>,
                            _root: &Option<Box<KaitaiStruct>>)
                            -> Result<Self>
...
impl Id017PtnairobConstantsFixed__NChunk {
}
