...
pub struct Id007Psdelph1ScriptLoc {
    pub _root: SharedType<Id007Psdelph1ScriptLoc>,
    pub _parent: SharedType<Id007Psdelph1ScriptLoc>,
    pub _self: SharedType<Self>,
    micheline__location: RefCell<i32>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id007Psdelph1ScriptLoc {
    type Root = Id007Psdelph1ScriptLoc;
    type Parent = Id007Psdelph1ScriptLoc;
