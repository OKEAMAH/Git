...
pub struct Id017PtnairobScriptLoc {
    pub _root: SharedType<Id017PtnairobScriptLoc>,
    pub _parent: SharedType<Id017PtnairobScriptLoc>,
    pub _self: SharedType<Self>,
    micheline__location: RefCell<i32>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id017PtnairobScriptLoc {
    type Root = Id017PtnairobScriptLoc;
    type Parent = Id017PtnairobScriptLoc;
