...
pub struct Id017PtnairobConstantsParametric {
    pub _root: SharedType<Id017PtnairobConstantsParametric>,
    pub _parent: SharedType<Id017PtnairobConstantsParametric>,
    ...
    hard_gas_limit_per_operation: RefCell<OptRc<Id017PtnairobConstantsParametric_Z>>,
    hard_gas_limit_per_block: RefCell<OptRc<Id017PtnairobConstantsParametric_Z>>,
    proof_of_work_threshold: RefCell<i64>,
    minimal_stake: RefCell<OptRc<Id017PtnairobConstantsParametric_N>>,
    vdf_difficulty: RefCell<i64>,
    seed_nonce_revelation_tip: RefCell<OptRc<Id017PtnairobConstantsParametric_N>>,
    origination_size: RefCell<i32>,
    baking_reward_fixed_portion: RefCell<OptRc<Id017PtnairobConstantsParametric_N>>,
    baking_reward_bonus_per_slot: RefCell<OptRc<Id017PtnairobConstantsParametric_N>>,
    endorsing_reward_per_slot: RefCell<OptRc<Id017PtnairobConstantsParametric_N>>,
    cost_per_byte: RefCell<OptRc<Id017PtnairobConstantsParametric_N>>,
    hard_storage_limit_per_operation: RefCell<OptRc<Id017PtnairobConstantsParametric_Z>>,
    quorum_min: RefCell<i32>,
    quorum_max: RefCell<i32>,
    min_proposal_quorum: RefCell<i32>,
    liquidity_baking_subsidy: RefCell<OptRc<Id017PtnairobConstantsParametric_N>>,
    ...
    minimal_participation_ratio: RefCell<OptRc<Id017PtnairobConstantsParametric_MinimalParticipationRatio>>,
    max_slashing_period: RefCell<i32>,
    frozen_deposits_percentage: RefCell<i32>,
    double_baking_punishment: RefCell<OptRc<Id017PtnairobConstantsParametric_N>>,
    ratio_of_frozen_deposits_slashed_per_double_endorsement: RefCell<OptRc<Id017PtnairobConstantsParametric_RatioOfFrozenDepositsSlashedPerDoubleEndorsement>>,
    testnet_dictator_tag: RefCell<Id017PtnairobConstantsParametric_Bool>,
    testnet_dictator: RefCell<OptRc<Id017PtnairobConstantsParametric_PublicKeyHash>>,
    initial_seed_tag: RefCell<Id017PtnairobConstantsParametric_Bool>,
    ...
    tx_rollup_enable: RefCell<Id017PtnairobConstantsParametric_Bool>,
    ...
    tx_rollup_commitment_bond: RefCell<OptRc<Id017PtnairobConstantsParametric_N>>,
    ...
    dal_parametric: RefCell<OptRc<Id017PtnairobConstantsParametric_DalParametric>>,
    smart_rollup_enable: RefCell<Id017PtnairobConstantsParametric_Bool>,
    smart_rollup_arith_pvm_enable: RefCell<Id017PtnairobConstantsParametric_Bool>,
    smart_rollup_origination_size: RefCell<i32>,
    smart_rollup_challenge_window_in_blocks: RefCell<i32>,
    smart_rollup_stake_amount: RefCell<OptRc<Id017PtnairobConstantsParametric_N>>,
    ...
    zk_rollup_enable: RefCell<Id017PtnairobConstantsParametric_Bool>,
    zk_rollup_origination_size: RefCell<i32>,
    zk_rollup_min_pending_to_process: RefCell<i32>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id017PtnairobConstantsParametric {
    type Root = Id017PtnairobConstantsParametric;
    type Parent = Id017PtnairobConstantsParametric;
    ...
    fn read<S: KStream>(
        ...
        *self_rc.cycles_per_voting_period.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id017PtnairobConstantsParametric_Z>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.proof_of_work_threshold.borrow_mut() = _io.read_s8be()?.into();
        let t = Self::read_into::<_, Id017PtnairobConstantsParametric_N>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.consensus_threshold.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id017PtnairobConstantsParametric_MinimalParticipationRatio>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.double_baking_punishment.borrow_mut() = t;
        let t = Self::read_into::<_, Id017PtnairobConstantsParametric_RatioOfFrozenDepositsSlashedPerDoubleEndorsement>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.testnet_dictator_tag.borrow_mut() = (_io.read_u1()? as i64).try_into()?;
        if *self_rc.testnet_dictator_tag() == Id017PtnairobConstantsParametric_Bool::True {
            let t = Self::read_into::<_, Id017PtnairobConstantsParametric_PublicKeyHash>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
            *self_rc.testnet_dictator.borrow_mut() = t;
        }
        *self_rc.initial_seed_tag.borrow_mut() = (_io.read_u1()? as i64).try_into()?;
        if *self_rc.initial_seed_tag() == Id017PtnairobConstantsParametric_Bool::True {
        ...
        *self_rc.tx_rollup_sunset_level.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id017PtnairobConstantsParametric_DalParametric>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
...
impl Id017PtnairobConstantsParametric {
}
impl Id017PtnairobConstantsParametric {
...
impl Id017PtnairobConstantsParametric {
    pub fn hard_gas_limit_per_operation(&self) -> Ref<OptRc<Id017PtnairobConstantsParametric_Z>> {
        self.hard_gas_limit_per_operation.borrow()
    }
}
impl Id017PtnairobConstantsParametric {
    pub fn hard_gas_limit_per_block(&self) -> Ref<OptRc<Id017PtnairobConstantsParametric_Z>> {
...
impl Id017PtnairobConstantsParametric {
    pub fn minimal_stake(&self) -> Ref<OptRc<Id017PtnairobConstantsParametric_N>> {
...
impl Id017PtnairobConstantsParametric {
    pub fn seed_nonce_revelation_tip(&self) -> Ref<OptRc<Id017PtnairobConstantsParametric_N>> {
...
impl Id017PtnairobConstantsParametric {
    pub fn baking_reward_fixed_portion(&self) -> Ref<OptRc<Id017PtnairobConstantsParametric_N>> {
        self.baking_reward_fixed_portion.borrow()
    }
}
impl Id017PtnairobConstantsParametric {
    pub fn baking_reward_bonus_per_slot(&self) -> Ref<OptRc<Id017PtnairobConstantsParametric_N>> {
        self.baking_reward_bonus_per_slot.borrow()
    }
}
impl Id017PtnairobConstantsParametric {
    pub fn endorsing_reward_per_slot(&self) -> Ref<OptRc<Id017PtnairobConstantsParametric_N>> {
        self.endorsing_reward_per_slot.borrow()
    }
}
impl Id017PtnairobConstantsParametric {
    pub fn cost_per_byte(&self) -> Ref<OptRc<Id017PtnairobConstantsParametric_N>> {
        self.cost_per_byte.borrow()
    }
}
impl Id017PtnairobConstantsParametric {
    pub fn hard_storage_limit_per_operation(&self) -> Ref<OptRc<Id017PtnairobConstantsParametric_Z>> {
...
impl Id017PtnairobConstantsParametric {
    pub fn liquidity_baking_subsidy(&self) -> Ref<OptRc<Id017PtnairobConstantsParametric_N>> {
...
impl Id017PtnairobConstantsParametric {
    pub fn minimal_participation_ratio(&self) -> Ref<OptRc<Id017PtnairobConstantsParametric_MinimalParticipationRatio>> {
...
impl Id017PtnairobConstantsParametric {
    pub fn double_baking_punishment(&self) -> Ref<OptRc<Id017PtnairobConstantsParametric_N>> {
        self.double_baking_punishment.borrow()
    }
}
impl Id017PtnairobConstantsParametric {
    pub fn ratio_of_frozen_deposits_slashed_per_double_endorsement(&self) -> Ref<OptRc<Id017PtnairobConstantsParametric_RatioOfFrozenDepositsSlashedPerDoubleEndorsement>> {
        self.ratio_of_frozen_deposits_slashed_per_double_endorsement.borrow()
    }
}
impl Id017PtnairobConstantsParametric {
    pub fn testnet_dictator_tag(&self) -> Ref<Id017PtnairobConstantsParametric_Bool> {
        self.testnet_dictator_tag.borrow()
    }
}
impl Id017PtnairobConstantsParametric {
    pub fn testnet_dictator(&self) -> Ref<OptRc<Id017PtnairobConstantsParametric_PublicKeyHash>> {
        self.testnet_dictator.borrow()
    }
}
impl Id017PtnairobConstantsParametric {
    pub fn initial_seed_tag(&self) -> Ref<Id017PtnairobConstantsParametric_Bool> {
...
impl Id017PtnairobConstantsParametric {
    pub fn tx_rollup_enable(&self) -> Ref<Id017PtnairobConstantsParametric_Bool> {
...
impl Id017PtnairobConstantsParametric {
    pub fn tx_rollup_commitment_bond(&self) -> Ref<OptRc<Id017PtnairobConstantsParametric_N>> {
...
impl Id017PtnairobConstantsParametric {
    pub fn dal_parametric(&self) -> Ref<OptRc<Id017PtnairobConstantsParametric_DalParametric>> {
        self.dal_parametric.borrow()
    }
}
impl Id017PtnairobConstantsParametric {
    pub fn smart_rollup_enable(&self) -> Ref<Id017PtnairobConstantsParametric_Bool> {
        self.smart_rollup_enable.borrow()
    }
}
impl Id017PtnairobConstantsParametric {
    pub fn smart_rollup_arith_pvm_enable(&self) -> Ref<Id017PtnairobConstantsParametric_Bool> {
...
impl Id017PtnairobConstantsParametric {
    pub fn smart_rollup_stake_amount(&self) -> Ref<OptRc<Id017PtnairobConstantsParametric_N>> {
...
impl Id017PtnairobConstantsParametric {
    pub fn zk_rollup_enable(&self) -> Ref<Id017PtnairobConstantsParametric_Bool> {
...
pub enum Id017PtnairobConstantsParametric_PublicKeyHashTag {
    Ed25519,
    Secp256k1,
    P256,
    Bls,
...
impl TryFrom<i64> for Id017PtnairobConstantsParametric_PublicKeyHashTag {
    type Error = KError;
    fn try_from(flag: i64) -> KResult<Id017PtnairobConstantsParametric_PublicKeyHashTag> {
        match flag {
            0 => Ok(Id017PtnairobConstantsParametric_PublicKeyHashTag::Ed25519),
            1 => Ok(Id017PtnairobConstantsParametric_PublicKeyHashTag::Secp256k1),
            2 => Ok(Id017PtnairobConstantsParametric_PublicKeyHashTag::P256),
            3 => Ok(Id017PtnairobConstantsParametric_PublicKeyHashTag::Bls),
            _ => Ok(Id017PtnairobConstantsParametric_PublicKeyHashTag::Unknown(flag)),
        }
    }
}

impl From<&Id017PtnairobConstantsParametric_PublicKeyHashTag> for i64 {
    fn from(v: &Id017PtnairobConstantsParametric_PublicKeyHashTag) -> Self {
        match *v {
            Id017PtnairobConstantsParametric_PublicKeyHashTag::Ed25519 => 0,
            Id017PtnairobConstantsParametric_PublicKeyHashTag::Secp256k1 => 1,
            Id017PtnairobConstantsParametric_PublicKeyHashTag::P256 => 2,
            Id017PtnairobConstantsParametric_PublicKeyHashTag::Bls => 3,
            Id017PtnairobConstantsParametric_PublicKeyHashTag::Unknown(v) => v
        }
    }
}

impl Default for Id017PtnairobConstantsParametric_PublicKeyHashTag {
    fn default() -> Self { Id017PtnairobConstantsParametric_PublicKeyHashTag::Unknown(0) }
}

#[derive(Debug, PartialEq, Clone)]
pub enum Id017PtnairobConstantsParametric_Bool {
    False,
    True,
    Unknown(i64),
}

impl TryFrom<i64> for Id017PtnairobConstantsParametric_Bool {
    type Error = KError;
    fn try_from(flag: i64) -> KResult<Id017PtnairobConstantsParametric_Bool> {
        match flag {
            0 => Ok(Id017PtnairobConstantsParametric_Bool::False),
            255 => Ok(Id017PtnairobConstantsParametric_Bool::True),
            _ => Ok(Id017PtnairobConstantsParametric_Bool::Unknown(flag)),
        }
    }
}

impl From<&Id017PtnairobConstantsParametric_Bool> for i64 {
    fn from(v: &Id017PtnairobConstantsParametric_Bool) -> Self {
        match *v {
            Id017PtnairobConstantsParametric_Bool::False => 0,
            Id017PtnairobConstantsParametric_Bool::True => 255,
            Id017PtnairobConstantsParametric_Bool::Unknown(v) => v
        }
    }
}

impl Default for Id017PtnairobConstantsParametric_Bool {
    fn default() -> Self { Id017PtnairobConstantsParametric_Bool::Unknown(0) }
}


#[derive(Default, Debug, Clone)]
pub struct Id017PtnairobConstantsParametric_RatioOfFrozenDepositsSlashedPerDoubleEndorsement {
    pub _root: SharedType<Id017PtnairobConstantsParametric>,
    pub _parent: SharedType<Id017PtnairobConstantsParametric>,
    pub _self: SharedType<Self>,
...
impl KStruct for Id017PtnairobConstantsParametric_RatioOfFrozenDepositsSlashedPerDoubleEndorsement {
    type Root = Id017PtnairobConstantsParametric;
    type Parent = Id017PtnairobConstantsParametric;
...
impl Id017PtnairobConstantsParametric_RatioOfFrozenDepositsSlashedPerDoubleEndorsement {
}
impl Id017PtnairobConstantsParametric_RatioOfFrozenDepositsSlashedPerDoubleEndorsement {
...
#[derive(Default, Debug, Clone)]
pub struct Id017PtnairobConstantsParametric_DalParametric {
    pub _root: SharedType<Id017PtnairobConstantsParametric>,
    pub _parent: SharedType<Id017PtnairobConstantsParametric>,
    pub _self: SharedType<Self>,
    feature_enable: RefCell<Id017PtnairobConstantsParametric_Bool>,
...
impl KStruct for Id017PtnairobConstantsParametric_DalParametric {
    type Root = Id017PtnairobConstantsParametric;
    type Parent = Id017PtnairobConstantsParametric;
...
impl Id017PtnairobConstantsParametric_DalParametric {
}
impl Id017PtnairobConstantsParametric_DalParametric {
    pub fn feature_enable(&self) -> Ref<Id017PtnairobConstantsParametric_Bool> {
...
#[derive(Default, Debug, Clone)]
pub struct Id017PtnairobConstantsParametric_N {
    pub _root: SharedType<Id017PtnairobConstantsParametric>,
    pub _parent: SharedType<Id017PtnairobConstantsParametric>,
    pub _self: SharedType<Self>,
    n: RefCell<Vec<OptRc<Id017PtnairobConstantsParametric_NChunk>>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id017PtnairobConstantsParametric_N {
    type Root = Id017PtnairobConstantsParametric;
    type Parent = Id017PtnairobConstantsParametric;
        ...
        *self_rc.n.borrow_mut() = Vec::new();
        {
            let mut _i = 0;
            while {
                let t = Self::read_into::<_, Id017PtnairobConstantsParametric_NChunk>(&*_io, Some(self_rc._root.clone()), None)?.into();
...
impl Id017PtnairobConstantsParametric_N {
}
impl Id017PtnairobConstantsParametric_N {
    pub fn n(&self) -> Ref<Vec<OptRc<Id017PtnairobConstantsParametric_NChunk>>> {
        self.n.borrow()
    }
}
impl Id017PtnairobConstantsParametric_N {
...
#[derive(Default, Debug, Clone)]
pub struct Id017PtnairobConstantsParametric_MinimalParticipationRatio {
    pub _root: SharedType<Id017PtnairobConstantsParametric>,
    pub _parent: SharedType<Id017PtnairobConstantsParametric>,
    pub _self: SharedType<Self>,
    numerator: RefCell<u16>,
...
impl KStruct for Id017PtnairobConstantsParametric_MinimalParticipationRatio {
    type Root = Id017PtnairobConstantsParametric;
    type Parent = Id017PtnairobConstantsParametric;
...
impl Id017PtnairobConstantsParametric_MinimalParticipationRatio {
}
impl Id017PtnairobConstantsParametric_MinimalParticipationRatio {
    pub fn numerator(&self) -> Ref<u16> {
        self.numerator.borrow()
...
#[derive(Default, Debug, Clone)]
pub struct Id017PtnairobConstantsParametric_NChunk {
    pub _root: SharedType<Id017PtnairobConstantsParametric>,
...
impl KStruct for Id017PtnairobConstantsParametric_NChunk {
    type Root = Id017PtnairobConstantsParametric;
...
impl Id017PtnairobConstantsParametric_NChunk {
}
impl Id017PtnairobConstantsParametric_NChunk {
...
#[derive(Default, Debug, Clone)]
pub struct Id017PtnairobConstantsParametric_PublicKeyHash {
    pub _root: SharedType<Id017PtnairobConstantsParametric>,
    pub _parent: SharedType<Id017PtnairobConstantsParametric>,
    pub _self: SharedType<Self>,
    public_key_hash_tag: RefCell<Id017PtnairobConstantsParametric_PublicKeyHashTag>,
...
impl KStruct for Id017PtnairobConstantsParametric_PublicKeyHash {
    type Root = Id017PtnairobConstantsParametric;
    type Parent = Id017PtnairobConstantsParametric;
    ...
    fn read<S: KStream>(
        ...
        *self_rc.public_key_hash_tag.borrow_mut() = (_io.read_u1()? as i64).try_into()?;
        if *self_rc.public_key_hash_tag() == Id017PtnairobConstantsParametric_PublicKeyHashTag::Ed25519 {
            *self_rc.public_key_hash_ed25519.borrow_mut() = _io.read_bytes(20 as usize)?.into();
        }
        if *self_rc.public_key_hash_tag() == Id017PtnairobConstantsParametric_PublicKeyHashTag::Secp256k1 {
            *self_rc.public_key_hash_secp256k1.borrow_mut() = _io.read_bytes(20 as usize)?.into();
        }
        if *self_rc.public_key_hash_tag() == Id017PtnairobConstantsParametric_PublicKeyHashTag::P256 {
            *self_rc.public_key_hash_p256.borrow_mut() = _io.read_bytes(20 as usize)?.into();
        }
        if *self_rc.public_key_hash_tag() == Id017PtnairobConstantsParametric_PublicKeyHashTag::Bls {
            *self_rc.public_key_hash_bls.borrow_mut() = _io.read_bytes(20 as usize)?.into();
        }
        Ok(())
    }
}
impl Id017PtnairobConstantsParametric_PublicKeyHash {
}
impl Id017PtnairobConstantsParametric_PublicKeyHash {
    pub fn public_key_hash_tag(&self) -> Ref<Id017PtnairobConstantsParametric_PublicKeyHashTag> {
...
#[derive(Default, Debug, Clone)]
pub struct Id017PtnairobConstantsParametric_Z {
    pub _root: SharedType<Id017PtnairobConstantsParametric>,
    pub _parent: SharedType<Id017PtnairobConstantsParametric>,
    pub _self: SharedType<Self>,
    ...
    sign: RefCell<bool>,
    payload: RefCell<u64>,
    tail: RefCell<Vec<OptRc<Id017PtnairobConstantsParametric_NChunk>>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id017PtnairobConstantsParametric_Z {
    type Root = Id017PtnairobConstantsParametric;
    type Parent = Id017PtnairobConstantsParametric;
...
impl Id017PtnairobConstantsParametric_Z {
}
impl Id017PtnairobConstantsParametric_Z {
...
impl Id017PtnairobConstantsParametric_Z {
    pub fn tail(&self) -> Ref<Vec<OptRc<Id017PtnairobConstantsParametric_NChunk>>> {
        self.tail.borrow()
    }
}
impl Id017PtnairobConstantsParametric_Z {
