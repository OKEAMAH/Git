...
pub struct Id015PtlimaptConstants {
    pub _root: SharedType<Id015PtlimaptConstants>,
    pub _parent: SharedType<Id015PtlimaptConstants>,
    ...
    hard_gas_limit_per_operation: RefCell<OptRc<Id015PtlimaptConstants_Z>>,
    hard_gas_limit_per_block: RefCell<OptRc<Id015PtlimaptConstants_Z>>,
    proof_of_work_threshold: RefCell<i64>,
    minimal_stake: RefCell<OptRc<Id015PtlimaptConstants_N>>,
    vdf_difficulty: RefCell<i64>,
    seed_nonce_revelation_tip: RefCell<OptRc<Id015PtlimaptConstants_N>>,
    origination_size: RefCell<i32>,
    baking_reward_fixed_portion: RefCell<OptRc<Id015PtlimaptConstants_N>>,
    baking_reward_bonus_per_slot: RefCell<OptRc<Id015PtlimaptConstants_N>>,
    endorsing_reward_per_slot: RefCell<OptRc<Id015PtlimaptConstants_N>>,
    cost_per_byte: RefCell<OptRc<Id015PtlimaptConstants_N>>,
    hard_storage_limit_per_operation: RefCell<OptRc<Id015PtlimaptConstants_Z>>,
    quorum_min: RefCell<i32>,
    quorum_max: RefCell<i32>,
    min_proposal_quorum: RefCell<i32>,
    liquidity_baking_subsidy: RefCell<OptRc<Id015PtlimaptConstants_N>>,
    ...
    minimal_participation_ratio: RefCell<OptRc<Id015PtlimaptConstants_MinimalParticipationRatio>>,
    max_slashing_period: RefCell<i32>,
    frozen_deposits_percentage: RefCell<i32>,
    double_baking_punishment: RefCell<OptRc<Id015PtlimaptConstants_N>>,
    ratio_of_frozen_deposits_slashed_per_double_endorsement: RefCell<OptRc<Id015PtlimaptConstants_RatioOfFrozenDepositsSlashedPerDoubleEndorsement>>,
    testnet_dictator_tag: RefCell<Id015PtlimaptConstants_Bool>,
    testnet_dictator: RefCell<OptRc<Id015PtlimaptConstants_PublicKeyHash>>,
    initial_seed_tag: RefCell<Id015PtlimaptConstants_Bool>,
    ...
    tx_rollup_enable: RefCell<Id015PtlimaptConstants_Bool>,
    ...
    tx_rollup_commitment_bond: RefCell<OptRc<Id015PtlimaptConstants_N>>,
    ...
    dal_parametric: RefCell<OptRc<Id015PtlimaptConstants_DalParametric>>,
    sc_rollup_enable: RefCell<Id015PtlimaptConstants_Bool>,
    ...
    sc_rollup_stake_amount: RefCell<OptRc<Id015PtlimaptConstants_N>>,
    ...
    zk_rollup_enable: RefCell<Id015PtlimaptConstants_Bool>,
    zk_rollup_origination_size: RefCell<i32>,
    zk_rollup_min_pending_to_process: RefCell<i32>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id015PtlimaptConstants {
    type Root = Id015PtlimaptConstants;
    type Parent = Id015PtlimaptConstants;
    ...
    fn read<S: KStream>(
        ...
        *self_rc.cycles_per_voting_period.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id015PtlimaptConstants_Z>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.proof_of_work_threshold.borrow_mut() = _io.read_s8be()?.into();
        let t = Self::read_into::<_, Id015PtlimaptConstants_N>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.consensus_threshold.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id015PtlimaptConstants_MinimalParticipationRatio>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.double_baking_punishment.borrow_mut() = t;
        let t = Self::read_into::<_, Id015PtlimaptConstants_RatioOfFrozenDepositsSlashedPerDoubleEndorsement>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.testnet_dictator_tag.borrow_mut() = (_io.read_u1()? as i64).try_into()?;
        if *self_rc.testnet_dictator_tag() == Id015PtlimaptConstants_Bool::True {
            let t = Self::read_into::<_, Id015PtlimaptConstants_PublicKeyHash>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
            *self_rc.testnet_dictator.borrow_mut() = t;
        }
        *self_rc.initial_seed_tag.borrow_mut() = (_io.read_u1()? as i64).try_into()?;
        if *self_rc.initial_seed_tag() == Id015PtlimaptConstants_Bool::True {
        ...
        *self_rc.tx_rollup_sunset_level.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id015PtlimaptConstants_DalParametric>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
...
impl Id015PtlimaptConstants {
    pub fn hard_gas_limit_per_operation(&self) -> Ref<OptRc<Id015PtlimaptConstants_Z>> {
        self.hard_gas_limit_per_operation.borrow()
    }
}
impl Id015PtlimaptConstants {
    pub fn hard_gas_limit_per_block(&self) -> Ref<OptRc<Id015PtlimaptConstants_Z>> {
...
impl Id015PtlimaptConstants {
    pub fn minimal_stake(&self) -> Ref<OptRc<Id015PtlimaptConstants_N>> {
...
impl Id015PtlimaptConstants {
    pub fn seed_nonce_revelation_tip(&self) -> Ref<OptRc<Id015PtlimaptConstants_N>> {
...
impl Id015PtlimaptConstants {
    pub fn baking_reward_fixed_portion(&self) -> Ref<OptRc<Id015PtlimaptConstants_N>> {
        self.baking_reward_fixed_portion.borrow()
    }
}
impl Id015PtlimaptConstants {
    pub fn baking_reward_bonus_per_slot(&self) -> Ref<OptRc<Id015PtlimaptConstants_N>> {
        self.baking_reward_bonus_per_slot.borrow()
    }
}
impl Id015PtlimaptConstants {
    pub fn endorsing_reward_per_slot(&self) -> Ref<OptRc<Id015PtlimaptConstants_N>> {
        self.endorsing_reward_per_slot.borrow()
    }
}
impl Id015PtlimaptConstants {
    pub fn cost_per_byte(&self) -> Ref<OptRc<Id015PtlimaptConstants_N>> {
        self.cost_per_byte.borrow()
    }
}
impl Id015PtlimaptConstants {
    pub fn hard_storage_limit_per_operation(&self) -> Ref<OptRc<Id015PtlimaptConstants_Z>> {
...
impl Id015PtlimaptConstants {
    pub fn liquidity_baking_subsidy(&self) -> Ref<OptRc<Id015PtlimaptConstants_N>> {
...
impl Id015PtlimaptConstants {
    pub fn minimal_participation_ratio(&self) -> Ref<OptRc<Id015PtlimaptConstants_MinimalParticipationRatio>> {
...
impl Id015PtlimaptConstants {
    pub fn double_baking_punishment(&self) -> Ref<OptRc<Id015PtlimaptConstants_N>> {
        self.double_baking_punishment.borrow()
    }
}
impl Id015PtlimaptConstants {
    pub fn ratio_of_frozen_deposits_slashed_per_double_endorsement(&self) -> Ref<OptRc<Id015PtlimaptConstants_RatioOfFrozenDepositsSlashedPerDoubleEndorsement>> {
        self.ratio_of_frozen_deposits_slashed_per_double_endorsement.borrow()
    }
}
impl Id015PtlimaptConstants {
    pub fn testnet_dictator_tag(&self) -> Ref<Id015PtlimaptConstants_Bool> {
        self.testnet_dictator_tag.borrow()
    }
}
impl Id015PtlimaptConstants {
    pub fn testnet_dictator(&self) -> Ref<OptRc<Id015PtlimaptConstants_PublicKeyHash>> {
        self.testnet_dictator.borrow()
    }
}
impl Id015PtlimaptConstants {
    pub fn initial_seed_tag(&self) -> Ref<Id015PtlimaptConstants_Bool> {
...
impl Id015PtlimaptConstants {
    pub fn tx_rollup_enable(&self) -> Ref<Id015PtlimaptConstants_Bool> {
...
impl Id015PtlimaptConstants {
    pub fn tx_rollup_commitment_bond(&self) -> Ref<OptRc<Id015PtlimaptConstants_N>> {
...
impl Id015PtlimaptConstants {
    pub fn dal_parametric(&self) -> Ref<OptRc<Id015PtlimaptConstants_DalParametric>> {
        self.dal_parametric.borrow()
    }
}
impl Id015PtlimaptConstants {
    pub fn sc_rollup_enable(&self) -> Ref<Id015PtlimaptConstants_Bool> {
...
impl Id015PtlimaptConstants {
    pub fn sc_rollup_stake_amount(&self) -> Ref<OptRc<Id015PtlimaptConstants_N>> {
...
impl Id015PtlimaptConstants {
    pub fn zk_rollup_enable(&self) -> Ref<Id015PtlimaptConstants_Bool> {
...
pub enum Id015PtlimaptConstants_PublicKeyHashTag {
    Ed25519,
    Secp256k1,
    P256,
    Unknown(i64),
...
impl TryFrom<i64> for Id015PtlimaptConstants_PublicKeyHashTag {
    type Error = KError;
    fn try_from(flag: i64) -> KResult<Id015PtlimaptConstants_PublicKeyHashTag> {
        match flag {
            0 => Ok(Id015PtlimaptConstants_PublicKeyHashTag::Ed25519),
            1 => Ok(Id015PtlimaptConstants_PublicKeyHashTag::Secp256k1),
            2 => Ok(Id015PtlimaptConstants_PublicKeyHashTag::P256),
            _ => Ok(Id015PtlimaptConstants_PublicKeyHashTag::Unknown(flag)),
        }
    }
}

impl From<&Id015PtlimaptConstants_PublicKeyHashTag> for i64 {
    fn from(v: &Id015PtlimaptConstants_PublicKeyHashTag) -> Self {
        match *v {
            Id015PtlimaptConstants_PublicKeyHashTag::Ed25519 => 0,
            Id015PtlimaptConstants_PublicKeyHashTag::Secp256k1 => 1,
            Id015PtlimaptConstants_PublicKeyHashTag::P256 => 2,
            Id015PtlimaptConstants_PublicKeyHashTag::Unknown(v) => v
        }
    }
}

impl Default for Id015PtlimaptConstants_PublicKeyHashTag {
    fn default() -> Self { Id015PtlimaptConstants_PublicKeyHashTag::Unknown(0) }
}

#[derive(Debug, PartialEq, Clone)]
pub enum Id015PtlimaptConstants_Bool {
    False,
    True,
    Unknown(i64),
}

impl TryFrom<i64> for Id015PtlimaptConstants_Bool {
    type Error = KError;
    fn try_from(flag: i64) -> KResult<Id015PtlimaptConstants_Bool> {
        match flag {
            0 => Ok(Id015PtlimaptConstants_Bool::False),
            255 => Ok(Id015PtlimaptConstants_Bool::True),
            _ => Ok(Id015PtlimaptConstants_Bool::Unknown(flag)),
        }
    }
}

impl From<&Id015PtlimaptConstants_Bool> for i64 {
    fn from(v: &Id015PtlimaptConstants_Bool) -> Self {
        match *v {
            Id015PtlimaptConstants_Bool::False => 0,
            Id015PtlimaptConstants_Bool::True => 255,
            Id015PtlimaptConstants_Bool::Unknown(v) => v
        }
    }
}

impl Default for Id015PtlimaptConstants_Bool {
    fn default() -> Self { Id015PtlimaptConstants_Bool::Unknown(0) }
}


#[derive(Default, Debug, Clone)]
pub struct Id015PtlimaptConstants_RatioOfFrozenDepositsSlashedPerDoubleEndorsement {
    pub _root: SharedType<Id015PtlimaptConstants>,
    pub _parent: SharedType<Id015PtlimaptConstants>,
    pub _self: SharedType<Self>,
...
impl KStruct for Id015PtlimaptConstants_RatioOfFrozenDepositsSlashedPerDoubleEndorsement {
    type Root = Id015PtlimaptConstants;
    type Parent = Id015PtlimaptConstants;
...
impl Id015PtlimaptConstants_RatioOfFrozenDepositsSlashedPerDoubleEndorsement {
}
impl Id015PtlimaptConstants_RatioOfFrozenDepositsSlashedPerDoubleEndorsement {
...
#[derive(Default, Debug, Clone)]
pub struct Id015PtlimaptConstants_DalParametric {
    pub _root: SharedType<Id015PtlimaptConstants>,
    pub _parent: SharedType<Id015PtlimaptConstants>,
    pub _self: SharedType<Self>,
    feature_enable: RefCell<Id015PtlimaptConstants_Bool>,
...
impl KStruct for Id015PtlimaptConstants_DalParametric {
    type Root = Id015PtlimaptConstants;
    type Parent = Id015PtlimaptConstants;
...
impl Id015PtlimaptConstants_DalParametric {
}
impl Id015PtlimaptConstants_DalParametric {
    pub fn feature_enable(&self) -> Ref<Id015PtlimaptConstants_Bool> {
...
#[derive(Default, Debug, Clone)]
pub struct Id015PtlimaptConstants_N {
    pub _root: SharedType<Id015PtlimaptConstants>,
    pub _parent: SharedType<Id015PtlimaptConstants>,
    pub _self: SharedType<Self>,
    n: RefCell<Vec<OptRc<Id015PtlimaptConstants_NChunk>>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id015PtlimaptConstants_N {
    type Root = Id015PtlimaptConstants;
    type Parent = Id015PtlimaptConstants;
        ...
        *self_rc.n.borrow_mut() = Vec::new();
        {
            let mut _i = 0;
            while {
                let t = Self::read_into::<_, Id015PtlimaptConstants_NChunk>(&*_io, Some(self_rc._root.clone()), None)?.into();
...
impl Id015PtlimaptConstants_N {
}
impl Id015PtlimaptConstants_N {
    pub fn n(&self) -> Ref<Vec<OptRc<Id015PtlimaptConstants_NChunk>>> {
        self.n.borrow()
    }
}
impl Id015PtlimaptConstants_N {
...
#[derive(Default, Debug, Clone)]
pub struct Id015PtlimaptConstants_MinimalParticipationRatio {
    pub _root: SharedType<Id015PtlimaptConstants>,
    pub _parent: SharedType<Id015PtlimaptConstants>,
    pub _self: SharedType<Self>,
    numerator: RefCell<u16>,
...
impl KStruct for Id015PtlimaptConstants_MinimalParticipationRatio {
    type Root = Id015PtlimaptConstants;
    type Parent = Id015PtlimaptConstants;
...
impl Id015PtlimaptConstants_MinimalParticipationRatio {
}
impl Id015PtlimaptConstants_MinimalParticipationRatio {
    pub fn numerator(&self) -> Ref<u16> {
        self.numerator.borrow()
...
#[derive(Default, Debug, Clone)]
pub struct Id015PtlimaptConstants_NChunk {
    pub _root: SharedType<Id015PtlimaptConstants>,
...
impl KStruct for Id015PtlimaptConstants_NChunk {
    type Root = Id015PtlimaptConstants;
...
impl Id015PtlimaptConstants_NChunk {
}
impl Id015PtlimaptConstants_NChunk {
...
#[derive(Default, Debug, Clone)]
pub struct Id015PtlimaptConstants_PublicKeyHash {
    pub _root: SharedType<Id015PtlimaptConstants>,
    pub _parent: SharedType<Id015PtlimaptConstants>,
    pub _self: SharedType<Self>,
    public_key_hash_tag: RefCell<Id015PtlimaptConstants_PublicKeyHashTag>,
    public_key_hash_ed25519: RefCell<Vec<u8>>,
    public_key_hash_secp256k1: RefCell<Vec<u8>>,
    public_key_hash_p256: RefCell<Vec<u8>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id015PtlimaptConstants_PublicKeyHash {
    type Root = Id015PtlimaptConstants;
    type Parent = Id015PtlimaptConstants;
    ...
    fn read<S: KStream>(
        ...
        *self_rc.public_key_hash_tag.borrow_mut() = (_io.read_u1()? as i64).try_into()?;
        if *self_rc.public_key_hash_tag() == Id015PtlimaptConstants_PublicKeyHashTag::Ed25519 {
            *self_rc.public_key_hash_ed25519.borrow_mut() = _io.read_bytes(20 as usize)?.into();
        }
        if *self_rc.public_key_hash_tag() == Id015PtlimaptConstants_PublicKeyHashTag::Secp256k1 {
            *self_rc.public_key_hash_secp256k1.borrow_mut() = _io.read_bytes(20 as usize)?.into();
        }
        if *self_rc.public_key_hash_tag() == Id015PtlimaptConstants_PublicKeyHashTag::P256 {
            *self_rc.public_key_hash_p256.borrow_mut() = _io.read_bytes(20 as usize)?.into();
        }
        Ok(())
    }
}
impl Id015PtlimaptConstants_PublicKeyHash {
}
impl Id015PtlimaptConstants_PublicKeyHash {
    pub fn public_key_hash_tag(&self) -> Ref<Id015PtlimaptConstants_PublicKeyHashTag> {
...
#[derive(Default, Debug, Clone)]
pub struct Id015PtlimaptConstants_Z {
    pub _root: SharedType<Id015PtlimaptConstants>,
    pub _parent: SharedType<Id015PtlimaptConstants>,
    pub _self: SharedType<Self>,
    ...
    sign: RefCell<bool>,
    payload: RefCell<u64>,
    tail: RefCell<Vec<OptRc<Id015PtlimaptConstants_NChunk>>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id015PtlimaptConstants_Z {
    type Root = Id015PtlimaptConstants;
    type Parent = Id015PtlimaptConstants;
...
impl Id015PtlimaptConstants_Z {
    pub fn tail(&self) -> Ref<Vec<OptRc<Id015PtlimaptConstants_NChunk>>> {
        self.tail.borrow()
    }
}
impl Id015PtlimaptConstants_Z {
