...
pub struct Id018ProxfordConstantsFixed {
    pub _root: SharedType<Id018ProxfordConstantsFixed>,
    pub _parent: SharedType<Id018ProxfordConstantsFixed>,
    ...
    smart_rollup_max_number_of_messages_per_level: RefCell<OptRc<Id018ProxfordConstantsFixed_N>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id018ProxfordConstantsFixed {
    type Root = Id018ProxfordConstantsFixed;
    type Parent = Id018ProxfordConstantsFixed;
    ...
    fn read<S: KStream>(
        ...
        *self_rc.smart_rollup_message_size_limit.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id018ProxfordConstantsFixed_N>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
...
impl Id018ProxfordConstantsFixed {
    pub fn smart_rollup_max_number_of_messages_per_level(&self) -> Ref<OptRc<Id018ProxfordConstantsFixed_N>> {
...
#[derive(Default, Debug, Clone)]
pub struct Id018ProxfordConstantsFixed_N {
    pub _root: SharedType<Id018ProxfordConstantsFixed>,
    pub _parent: SharedType<Id018ProxfordConstantsFixed>,
    pub _self: SharedType<Self>,
    n: RefCell<Vec<OptRc<Id018ProxfordConstantsFixed_NChunk>>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id018ProxfordConstantsFixed_N {
    type Root = Id018ProxfordConstantsFixed;
    type Parent = Id018ProxfordConstantsFixed;
        ...
        *self_rc.n.borrow_mut() = Vec::new();
        {
            let mut _i = 0;
            while {
                let t = Self::read_into::<_, Id018ProxfordConstantsFixed_NChunk>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
...
impl Id018ProxfordConstantsFixed_N {
}
impl Id018ProxfordConstantsFixed_N {
    pub fn n(&self) -> Ref<Vec<OptRc<Id018ProxfordConstantsFixed_NChunk>>> {
        self.n.borrow()
    }
}
impl Id018ProxfordConstantsFixed_N {
...
#[derive(Default, Debug, Clone)]
pub struct Id018ProxfordConstantsFixed_NChunk {
    pub _root: SharedType<Id018ProxfordConstantsFixed>,
    pub _parent: SharedType<Id018ProxfordConstantsFixed_N>,
    pub _self: SharedType<Self>,
    has_more: RefCell<bool>,
    payload: RefCell<u64>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id018ProxfordConstantsFixed_NChunk {
    type Root = Id018ProxfordConstantsFixed;
    type Parent = Id018ProxfordConstantsFixed_N;
...
impl Id018ProxfordConstantsFixed_NChunk {
}
impl Id018ProxfordConstantsFixed_NChunk {
