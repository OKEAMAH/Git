...
pub struct AlphaTimestamp {
    pub _root: SharedType<AlphaTimestamp>,
    pub _parent: SharedType<AlphaTimestamp>,
    pub _self: SharedType<Self>,
    timestamp__protocol: RefCell<i64>,
    _io: RefCell<BytesReader>,
}
impl KStruct for AlphaTimestamp {
    type Root = AlphaTimestamp;
    type Parent = AlphaTimestamp;
