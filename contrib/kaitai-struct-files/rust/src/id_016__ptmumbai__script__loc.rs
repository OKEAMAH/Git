...
pub struct Id016PtmumbaiScriptLoc {
    pub _root: SharedType<Id016PtmumbaiScriptLoc>,
    pub _parent: SharedType<Id016PtmumbaiScriptLoc>,
    pub _self: SharedType<Self>,
    micheline__location: RefCell<i32>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id016PtmumbaiScriptLoc {
    type Root = Id016PtmumbaiScriptLoc;
    type Parent = Id016PtmumbaiScriptLoc;
