...
pub struct Id010PtgranadLevel {
    pub _root: SharedType<Id010PtgranadLevel>,
    pub _parent: SharedType<Id010PtgranadLevel>,
    pub _self: SharedType<Self>,
    level: RefCell<i32>,
    level_position: RefCell<i32>,
    cycle: RefCell<i32>,
    cycle_position: RefCell<i32>,
    expected_commitment: RefCell<Id010PtgranadLevel_Bool>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id010PtgranadLevel {
    type Root = Id010PtgranadLevel;
    type Parent = Id010PtgranadLevel;
 ...
 */
impl Id010PtgranadLevel {
    pub fn expected_commitment(&self) -> Ref<Id010PtgranadLevel_Bool> {
...
pub enum Id010PtgranadLevel_Bool {
    False,
    True,
    Unknown(i64),
}

impl TryFrom<i64> for Id010PtgranadLevel_Bool {
    type Error = KError;
    fn try_from(flag: i64) -> KResult<Id010PtgranadLevel_Bool> {
        match flag {
            0 => Ok(Id010PtgranadLevel_Bool::False),
            255 => Ok(Id010PtgranadLevel_Bool::True),
            _ => Ok(Id010PtgranadLevel_Bool::Unknown(flag)),
        }
    }
}

impl From<&Id010PtgranadLevel_Bool> for i64 {
    fn from(v: &Id010PtgranadLevel_Bool) -> Self {
        match *v {
            Id010PtgranadLevel_Bool::False => 0,
            Id010PtgranadLevel_Bool::True => 255,
            Id010PtgranadLevel_Bool::Unknown(v) => v
        }
    }
}

impl Default for Id010PtgranadLevel_Bool {
    fn default() -> Self { Id010PtgranadLevel_Bool::Unknown(0) }
}
