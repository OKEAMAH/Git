...
pub struct Id017PtnairobLevel {
    pub _root: SharedType<Id017PtnairobLevel>,
    pub _parent: SharedType<Id017PtnairobLevel>,
    pub _self: SharedType<Self>,
    level: RefCell<i32>,
    level_position: RefCell<i32>,
    cycle: RefCell<i32>,
    cycle_position: RefCell<i32>,
    expected_commitment: RefCell<Id017PtnairobLevel_Bool>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id017PtnairobLevel {
    type Root = Id017PtnairobLevel;
    type Parent = Id017PtnairobLevel;
 ...
 */
impl Id017PtnairobLevel {
    pub fn expected_commitment(&self) -> Ref<Id017PtnairobLevel_Bool> {
...
pub enum Id017PtnairobLevel_Bool {
    False,
    True,
    Unknown(i64),
}

impl TryFrom<i64> for Id017PtnairobLevel_Bool {
    type Error = KError;
    fn try_from(flag: i64) -> KResult<Id017PtnairobLevel_Bool> {
        match flag {
            0 => Ok(Id017PtnairobLevel_Bool::False),
            255 => Ok(Id017PtnairobLevel_Bool::True),
            _ => Ok(Id017PtnairobLevel_Bool::Unknown(flag)),
        }
    }
}

impl From<&Id017PtnairobLevel_Bool> for i64 {
    fn from(v: &Id017PtnairobLevel_Bool) -> Self {
        match *v {
            Id017PtnairobLevel_Bool::False => 0,
            Id017PtnairobLevel_Bool::True => 255,
            Id017PtnairobLevel_Bool::Unknown(v) => v
        }
    }
}

impl Default for Id017PtnairobLevel_Bool {
    fn default() -> Self { Id017PtnairobLevel_Bool::Unknown(0) }
}
