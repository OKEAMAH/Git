...
pub struct Id018ProxfordScriptLoc {
    pub _root: SharedType<Id018ProxfordScriptLoc>,
    pub _parent: SharedType<Id018ProxfordScriptLoc>,
    pub _self: SharedType<Self>,
    micheline__location: RefCell<i32>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id018ProxfordScriptLoc {
    type Root = Id018ProxfordScriptLoc;
    type Parent = Id018ProxfordScriptLoc;
