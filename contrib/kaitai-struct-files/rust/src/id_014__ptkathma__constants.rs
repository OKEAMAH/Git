...
pub struct Id014PtkathmaConstants {
    pub _root: SharedType<Id014PtkathmaConstants>,
    pub _parent: SharedType<Id014PtkathmaConstants>,
    ...
    max_wrapped_proof_binary_size: RefCell<i32>,
    ...
    hard_gas_limit_per_operation: RefCell<OptRc<Id014PtkathmaConstants_Z>>,
    hard_gas_limit_per_block: RefCell<OptRc<Id014PtkathmaConstants_Z>>,
    proof_of_work_threshold: RefCell<i64>,
    tokens_per_roll: RefCell<OptRc<Id014PtkathmaConstants_N>>,
    vdf_difficulty: RefCell<i64>,
    seed_nonce_revelation_tip: RefCell<OptRc<Id014PtkathmaConstants_N>>,
    origination_size: RefCell<i32>,
    baking_reward_fixed_portion: RefCell<OptRc<Id014PtkathmaConstants_N>>,
    baking_reward_bonus_per_slot: RefCell<OptRc<Id014PtkathmaConstants_N>>,
    endorsing_reward_per_slot: RefCell<OptRc<Id014PtkathmaConstants_N>>,
    cost_per_byte: RefCell<OptRc<Id014PtkathmaConstants_N>>,
    hard_storage_limit_per_operation: RefCell<OptRc<Id014PtkathmaConstants_Z>>,
    quorum_min: RefCell<i32>,
    quorum_max: RefCell<i32>,
    min_proposal_quorum: RefCell<i32>,
    liquidity_baking_subsidy: RefCell<OptRc<Id014PtkathmaConstants_N>>,
    ...
    minimal_participation_ratio: RefCell<OptRc<Id014PtkathmaConstants_MinimalParticipationRatio>>,
    max_slashing_period: RefCell<i32>,
    frozen_deposits_percentage: RefCell<i32>,
    double_baking_punishment: RefCell<OptRc<Id014PtkathmaConstants_N>>,
    ratio_of_frozen_deposits_slashed_per_double_endorsement: RefCell<OptRc<Id014PtkathmaConstants_RatioOfFrozenDepositsSlashedPerDoubleEndorsement>>,
    testnet_dictator_tag: RefCell<Id014PtkathmaConstants_Bool>,
    testnet_dictator: RefCell<OptRc<Id014PtkathmaConstants_PublicKeyHash>>,
    initial_seed_tag: RefCell<Id014PtkathmaConstants_Bool>,
    ...
    tx_rollup_enable: RefCell<Id014PtkathmaConstants_Bool>,
    ...
    tx_rollup_commitment_bond: RefCell<OptRc<Id014PtkathmaConstants_N>>,
    ...
    dal_parametric: RefCell<OptRc<Id014PtkathmaConstants_DalParametric>>,
    sc_rollup_enable: RefCell<Id014PtkathmaConstants_Bool>,
    ...
    sc_rollup_stake_amount: RefCell<OptRc<Id014PtkathmaConstants_N>>,
...
impl KStruct for Id014PtkathmaConstants {
    type Root = Id014PtkathmaConstants;
    type Parent = Id014PtkathmaConstants;
    ...
    fn read<S: KStream>(
        ...
        *self_rc.max_wrapped_proof_binary_size.borrow_mut() = _io.read_s4be()?.into();
        ...
        *self_rc.cycles_per_voting_period.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id014PtkathmaConstants_Z>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.proof_of_work_threshold.borrow_mut() = _io.read_s8be()?.into();
        let t = Self::read_into::<_, Id014PtkathmaConstants_N>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.consensus_threshold.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id014PtkathmaConstants_MinimalParticipationRatio>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.double_baking_punishment.borrow_mut() = t;
        let t = Self::read_into::<_, Id014PtkathmaConstants_RatioOfFrozenDepositsSlashedPerDoubleEndorsement>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.testnet_dictator_tag.borrow_mut() = (_io.read_u1()? as i64).try_into()?;
        if *self_rc.testnet_dictator_tag() == Id014PtkathmaConstants_Bool::True {
            let t = Self::read_into::<_, Id014PtkathmaConstants_PublicKeyHash>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
            *self_rc.testnet_dictator.borrow_mut() = t;
        }
        *self_rc.initial_seed_tag.borrow_mut() = (_io.read_u1()? as i64).try_into()?;
        if *self_rc.initial_seed_tag() == Id014PtkathmaConstants_Bool::True {
        ...
        *self_rc.tx_rollup_sunset_level.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id014PtkathmaConstants_DalParametric>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
...
impl Id014PtkathmaConstants {
    pub fn max_wrapped_proof_binary_size(&self) -> Ref<i32> {
        self.max_wrapped_proof_binary_size.borrow()
    }
}
impl Id014PtkathmaConstants {
...
impl Id014PtkathmaConstants {
    pub fn hard_gas_limit_per_operation(&self) -> Ref<OptRc<Id014PtkathmaConstants_Z>> {
        self.hard_gas_limit_per_operation.borrow()
    }
}
impl Id014PtkathmaConstants {
    pub fn hard_gas_limit_per_block(&self) -> Ref<OptRc<Id014PtkathmaConstants_Z>> {
...
impl Id014PtkathmaConstants {
    pub fn tokens_per_roll(&self) -> Ref<OptRc<Id014PtkathmaConstants_N>> {
...
impl Id014PtkathmaConstants {
    pub fn seed_nonce_revelation_tip(&self) -> Ref<OptRc<Id014PtkathmaConstants_N>> {
...
impl Id014PtkathmaConstants {
    pub fn baking_reward_fixed_portion(&self) -> Ref<OptRc<Id014PtkathmaConstants_N>> {
        self.baking_reward_fixed_portion.borrow()
    }
}
impl Id014PtkathmaConstants {
    pub fn baking_reward_bonus_per_slot(&self) -> Ref<OptRc<Id014PtkathmaConstants_N>> {
        self.baking_reward_bonus_per_slot.borrow()
    }
}
impl Id014PtkathmaConstants {
    pub fn endorsing_reward_per_slot(&self) -> Ref<OptRc<Id014PtkathmaConstants_N>> {
        self.endorsing_reward_per_slot.borrow()
    }
}
impl Id014PtkathmaConstants {
    pub fn cost_per_byte(&self) -> Ref<OptRc<Id014PtkathmaConstants_N>> {
        self.cost_per_byte.borrow()
    }
}
impl Id014PtkathmaConstants {
    pub fn hard_storage_limit_per_operation(&self) -> Ref<OptRc<Id014PtkathmaConstants_Z>> {
...
impl Id014PtkathmaConstants {
    pub fn liquidity_baking_subsidy(&self) -> Ref<OptRc<Id014PtkathmaConstants_N>> {
...
impl Id014PtkathmaConstants {
    pub fn minimal_participation_ratio(&self) -> Ref<OptRc<Id014PtkathmaConstants_MinimalParticipationRatio>> {
...
impl Id014PtkathmaConstants {
    pub fn double_baking_punishment(&self) -> Ref<OptRc<Id014PtkathmaConstants_N>> {
        self.double_baking_punishment.borrow()
    }
}
impl Id014PtkathmaConstants {
    pub fn ratio_of_frozen_deposits_slashed_per_double_endorsement(&self) -> Ref<OptRc<Id014PtkathmaConstants_RatioOfFrozenDepositsSlashedPerDoubleEndorsement>> {
        self.ratio_of_frozen_deposits_slashed_per_double_endorsement.borrow()
    }
}
impl Id014PtkathmaConstants {
    pub fn testnet_dictator_tag(&self) -> Ref<Id014PtkathmaConstants_Bool> {
        self.testnet_dictator_tag.borrow()
    }
}
impl Id014PtkathmaConstants {
    pub fn testnet_dictator(&self) -> Ref<OptRc<Id014PtkathmaConstants_PublicKeyHash>> {
        self.testnet_dictator.borrow()
    }
}
impl Id014PtkathmaConstants {
    pub fn initial_seed_tag(&self) -> Ref<Id014PtkathmaConstants_Bool> {
...
impl Id014PtkathmaConstants {
    pub fn tx_rollup_enable(&self) -> Ref<Id014PtkathmaConstants_Bool> {
...
impl Id014PtkathmaConstants {
    pub fn tx_rollup_commitment_bond(&self) -> Ref<OptRc<Id014PtkathmaConstants_N>> {
...
impl Id014PtkathmaConstants {
    pub fn dal_parametric(&self) -> Ref<OptRc<Id014PtkathmaConstants_DalParametric>> {
        self.dal_parametric.borrow()
    }
}
impl Id014PtkathmaConstants {
    pub fn sc_rollup_enable(&self) -> Ref<Id014PtkathmaConstants_Bool> {
...
impl Id014PtkathmaConstants {
    pub fn sc_rollup_stake_amount(&self) -> Ref<OptRc<Id014PtkathmaConstants_N>> {
...
pub enum Id014PtkathmaConstants_PublicKeyHashTag {
    Ed25519,
    Secp256k1,
    P256,
    Unknown(i64),
...
impl TryFrom<i64> for Id014PtkathmaConstants_PublicKeyHashTag {
    type Error = KError;
    fn try_from(flag: i64) -> KResult<Id014PtkathmaConstants_PublicKeyHashTag> {
        match flag {
            0 => Ok(Id014PtkathmaConstants_PublicKeyHashTag::Ed25519),
            1 => Ok(Id014PtkathmaConstants_PublicKeyHashTag::Secp256k1),
            2 => Ok(Id014PtkathmaConstants_PublicKeyHashTag::P256),
            _ => Ok(Id014PtkathmaConstants_PublicKeyHashTag::Unknown(flag)),
        }
    }
}

impl From<&Id014PtkathmaConstants_PublicKeyHashTag> for i64 {
    fn from(v: &Id014PtkathmaConstants_PublicKeyHashTag) -> Self {
        match *v {
            Id014PtkathmaConstants_PublicKeyHashTag::Ed25519 => 0,
            Id014PtkathmaConstants_PublicKeyHashTag::Secp256k1 => 1,
            Id014PtkathmaConstants_PublicKeyHashTag::P256 => 2,
            Id014PtkathmaConstants_PublicKeyHashTag::Unknown(v) => v
        }
    }
}

impl Default for Id014PtkathmaConstants_PublicKeyHashTag {
    fn default() -> Self { Id014PtkathmaConstants_PublicKeyHashTag::Unknown(0) }
}

#[derive(Debug, PartialEq, Clone)]
pub enum Id014PtkathmaConstants_Bool {
    False,
    True,
    Unknown(i64),
}

impl TryFrom<i64> for Id014PtkathmaConstants_Bool {
    type Error = KError;
    fn try_from(flag: i64) -> KResult<Id014PtkathmaConstants_Bool> {
        match flag {
            0 => Ok(Id014PtkathmaConstants_Bool::False),
            255 => Ok(Id014PtkathmaConstants_Bool::True),
            _ => Ok(Id014PtkathmaConstants_Bool::Unknown(flag)),
        }
    }
}

impl From<&Id014PtkathmaConstants_Bool> for i64 {
    fn from(v: &Id014PtkathmaConstants_Bool) -> Self {
        match *v {
            Id014PtkathmaConstants_Bool::False => 0,
            Id014PtkathmaConstants_Bool::True => 255,
            Id014PtkathmaConstants_Bool::Unknown(v) => v
        }
    }
}

impl Default for Id014PtkathmaConstants_Bool {
    fn default() -> Self { Id014PtkathmaConstants_Bool::Unknown(0) }
}


#[derive(Default, Debug, Clone)]
pub struct Id014PtkathmaConstants_RatioOfFrozenDepositsSlashedPerDoubleEndorsement {
    pub _root: SharedType<Id014PtkathmaConstants>,
    pub _parent: SharedType<Id014PtkathmaConstants>,
    pub _self: SharedType<Self>,
...
impl KStruct for Id014PtkathmaConstants_RatioOfFrozenDepositsSlashedPerDoubleEndorsement {
    type Root = Id014PtkathmaConstants;
    type Parent = Id014PtkathmaConstants;
...
impl Id014PtkathmaConstants_RatioOfFrozenDepositsSlashedPerDoubleEndorsement {
}
impl Id014PtkathmaConstants_RatioOfFrozenDepositsSlashedPerDoubleEndorsement {
...
#[derive(Default, Debug, Clone)]
pub struct Id014PtkathmaConstants_DalParametric {
    pub _root: SharedType<Id014PtkathmaConstants>,
    pub _parent: SharedType<Id014PtkathmaConstants>,
    pub _self: SharedType<Self>,
    feature_enable: RefCell<Id014PtkathmaConstants_Bool>,
...
impl KStruct for Id014PtkathmaConstants_DalParametric {
    type Root = Id014PtkathmaConstants;
    type Parent = Id014PtkathmaConstants;
...
impl Id014PtkathmaConstants_DalParametric {
}
impl Id014PtkathmaConstants_DalParametric {
    pub fn feature_enable(&self) -> Ref<Id014PtkathmaConstants_Bool> {
...
#[derive(Default, Debug, Clone)]
pub struct Id014PtkathmaConstants_N {
    pub _root: SharedType<Id014PtkathmaConstants>,
    pub _parent: SharedType<Id014PtkathmaConstants>,
    pub _self: SharedType<Self>,
    n: RefCell<Vec<OptRc<Id014PtkathmaConstants_NChunk>>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id014PtkathmaConstants_N {
    type Root = Id014PtkathmaConstants;
    type Parent = Id014PtkathmaConstants;
        ...
        *self_rc.n.borrow_mut() = Vec::new();
        {
            let mut _i = 0;
            while {
                let t = Self::read_into::<_, Id014PtkathmaConstants_NChunk>(&*_io, Some(self_rc._root.clone()), None)?.into();
...
impl Id014PtkathmaConstants_N {
}
impl Id014PtkathmaConstants_N {
    pub fn n(&self) -> Ref<Vec<OptRc<Id014PtkathmaConstants_NChunk>>> {
        self.n.borrow()
    }
}
impl Id014PtkathmaConstants_N {
...
#[derive(Default, Debug, Clone)]
pub struct Id014PtkathmaConstants_MinimalParticipationRatio {
    pub _root: SharedType<Id014PtkathmaConstants>,
    pub _parent: SharedType<Id014PtkathmaConstants>,
    pub _self: SharedType<Self>,
    numerator: RefCell<u16>,
...
impl KStruct for Id014PtkathmaConstants_MinimalParticipationRatio {
    type Root = Id014PtkathmaConstants;
    type Parent = Id014PtkathmaConstants;
...
impl Id014PtkathmaConstants_MinimalParticipationRatio {
}
impl Id014PtkathmaConstants_MinimalParticipationRatio {
    pub fn numerator(&self) -> Ref<u16> {
        self.numerator.borrow()
...
#[derive(Default, Debug, Clone)]
pub struct Id014PtkathmaConstants_NChunk {
    pub _root: SharedType<Id014PtkathmaConstants>,
...
impl KStruct for Id014PtkathmaConstants_NChunk {
    type Root = Id014PtkathmaConstants;
...
impl Id014PtkathmaConstants_NChunk {
}
impl Id014PtkathmaConstants_NChunk {
...
#[derive(Default, Debug, Clone)]
pub struct Id014PtkathmaConstants_PublicKeyHash {
    pub _root: SharedType<Id014PtkathmaConstants>,
    pub _parent: SharedType<Id014PtkathmaConstants>,
    pub _self: SharedType<Self>,
    public_key_hash_tag: RefCell<Id014PtkathmaConstants_PublicKeyHashTag>,
    public_key_hash_ed25519: RefCell<Vec<u8>>,
    public_key_hash_secp256k1: RefCell<Vec<u8>>,
    public_key_hash_p256: RefCell<Vec<u8>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id014PtkathmaConstants_PublicKeyHash {
    type Root = Id014PtkathmaConstants;
    type Parent = Id014PtkathmaConstants;
    ...
    fn read<S: KStream>(
        ...
        *self_rc.public_key_hash_tag.borrow_mut() = (_io.read_u1()? as i64).try_into()?;
        if *self_rc.public_key_hash_tag() == Id014PtkathmaConstants_PublicKeyHashTag::Ed25519 {
            *self_rc.public_key_hash_ed25519.borrow_mut() = _io.read_bytes(20 as usize)?.into();
        }
        if *self_rc.public_key_hash_tag() == Id014PtkathmaConstants_PublicKeyHashTag::Secp256k1 {
            *self_rc.public_key_hash_secp256k1.borrow_mut() = _io.read_bytes(20 as usize)?.into();
        }
        if *self_rc.public_key_hash_tag() == Id014PtkathmaConstants_PublicKeyHashTag::P256 {
            *self_rc.public_key_hash_p256.borrow_mut() = _io.read_bytes(20 as usize)?.into();
        }
        Ok(())
    }
}
impl Id014PtkathmaConstants_PublicKeyHash {
}
impl Id014PtkathmaConstants_PublicKeyHash {
    pub fn public_key_hash_tag(&self) -> Ref<Id014PtkathmaConstants_PublicKeyHashTag> {
...
#[derive(Default, Debug, Clone)]
pub struct Id014PtkathmaConstants_Z {
    pub _root: SharedType<Id014PtkathmaConstants>,
    pub _parent: SharedType<Id014PtkathmaConstants>,
    pub _self: SharedType<Self>,
    ...
    sign: RefCell<bool>,
    payload: RefCell<u64>,
    tail: RefCell<Vec<OptRc<Id014PtkathmaConstants_NChunk>>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id014PtkathmaConstants_Z {
    type Root = Id014PtkathmaConstants;
    type Parent = Id014PtkathmaConstants;
...
impl Id014PtkathmaConstants_Z {
    pub fn tail(&self) -> Ref<Vec<OptRc<Id014PtkathmaConstants_NChunk>>> {
        self.tail.borrow()
    }
}
impl Id014PtkathmaConstants_Z {
