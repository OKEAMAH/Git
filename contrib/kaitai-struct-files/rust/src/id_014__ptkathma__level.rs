...
pub struct Id014PtkathmaLevel {
    pub _root: SharedType<Id014PtkathmaLevel>,
    pub _parent: SharedType<Id014PtkathmaLevel>,
    pub _self: SharedType<Self>,
    level: RefCell<i32>,
    level_position: RefCell<i32>,
    cycle: RefCell<i32>,
    cycle_position: RefCell<i32>,
    expected_commitment: RefCell<Id014PtkathmaLevel_Bool>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id014PtkathmaLevel {
    type Root = Id014PtkathmaLevel;
    type Parent = Id014PtkathmaLevel;
 ...
 */
impl Id014PtkathmaLevel {
    pub fn expected_commitment(&self) -> Ref<Id014PtkathmaLevel_Bool> {
...
pub enum Id014PtkathmaLevel_Bool {
    False,
    True,
    Unknown(i64),
}

impl TryFrom<i64> for Id014PtkathmaLevel_Bool {
    type Error = KError;
    fn try_from(flag: i64) -> KResult<Id014PtkathmaLevel_Bool> {
        match flag {
            0 => Ok(Id014PtkathmaLevel_Bool::False),
            255 => Ok(Id014PtkathmaLevel_Bool::True),
            _ => Ok(Id014PtkathmaLevel_Bool::Unknown(flag)),
        }
    }
}

impl From<&Id014PtkathmaLevel_Bool> for i64 {
    fn from(v: &Id014PtkathmaLevel_Bool) -> Self {
        match *v {
            Id014PtkathmaLevel_Bool::False => 0,
            Id014PtkathmaLevel_Bool::True => 255,
            Id014PtkathmaLevel_Bool::Unknown(v) => v
        }
    }
}

impl Default for Id014PtkathmaLevel_Bool {
    fn default() -> Self { Id014PtkathmaLevel_Bool::Unknown(0) }
}
