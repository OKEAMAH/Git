...
pub struct Id012PsithacaScriptLoc {
    pub _root: SharedType<Id012PsithacaScriptLoc>,
    pub _parent: SharedType<Id012PsithacaScriptLoc>,
    pub _self: SharedType<Self>,
    micheline__location: RefCell<i32>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id012PsithacaScriptLoc {
    type Root = Id012PsithacaScriptLoc;
    type Parent = Id012PsithacaScriptLoc;
