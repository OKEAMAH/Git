...
pub struct Id006PscarthaScriptLoc {
    pub _root: SharedType<Id006PscarthaScriptLoc>,
    pub _parent: SharedType<Id006PscarthaScriptLoc>,
    pub _self: SharedType<Self>,
    micheline__location: RefCell<i32>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id006PscarthaScriptLoc {
    type Root = Id006PscarthaScriptLoc;
    type Parent = Id006PscarthaScriptLoc;
