...
pub struct Id015PtlimaptConstantsFixed {
    ...
    pub scMaxWrappedProofBinarySize: i32,
    pub scRollupMessageSizeLimit: i32,
}

impl KaitaiStruct for Id015PtlimaptConstantsFixed {
    ...
    fn read<S: KaitaiStream>(&mut self,
        ...
        self.scMaxWrappedProofBinarySize = self.stream.read_s4be()?;
        self.scRollupMessageSizeLimit = self.stream.read_s4be()?;
    }
}
