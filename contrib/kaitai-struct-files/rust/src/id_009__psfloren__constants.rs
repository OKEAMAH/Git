...
pub struct Id009PsflorenConstants {
    pub _root: SharedType<Id009PsflorenConstants>,
    pub _parent: SharedType<Id009PsflorenConstants>,
    ...
    time_between_blocks: RefCell<OptRc<Id009PsflorenConstants_TimeBetweenBlocks>>,
    endorsers_per_block: RefCell<u16>,
    hard_gas_limit_per_operation: RefCell<OptRc<Id009PsflorenConstants_Z>>,
    hard_gas_limit_per_block: RefCell<OptRc<Id009PsflorenConstants_Z>>,
    proof_of_work_threshold: RefCell<i64>,
    tokens_per_roll: RefCell<OptRc<Id009PsflorenConstants_N>>,
    michelson_maximum_type_size: RefCell<u16>,
    seed_nonce_revelation_tip: RefCell<OptRc<Id009PsflorenConstants_N>>,
    origination_size: RefCell<i32>,
    block_security_deposit: RefCell<OptRc<Id009PsflorenConstants_N>>,
    endorsement_security_deposit: RefCell<OptRc<Id009PsflorenConstants_N>>,
    baking_reward_per_endorsement: RefCell<OptRc<Id009PsflorenConstants_BakingRewardPerEndorsement>>,
    endorsement_reward: RefCell<OptRc<Id009PsflorenConstants_EndorsementReward>>,
    cost_per_byte: RefCell<OptRc<Id009PsflorenConstants_N>>,
    hard_storage_limit_per_operation: RefCell<OptRc<Id009PsflorenConstants_Z>>,
...
impl KStruct for Id009PsflorenConstants {
    type Root = Id009PsflorenConstants;
    type Parent = Id009PsflorenConstants;
    ...
    fn read<S: KStream>(
        ...
        *self_rc.blocks_per_voting_period.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id009PsflorenConstants_TimeBetweenBlocks>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        *self_rc.time_between_blocks.borrow_mut() = t;
        *self_rc.endorsers_per_block.borrow_mut() = _io.read_u2be()?.into();
        let t = Self::read_into::<_, Id009PsflorenConstants_Z>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.proof_of_work_threshold.borrow_mut() = _io.read_s8be()?.into();
        let t = Self::read_into::<_, Id009PsflorenConstants_N>(&*_io, Some(self_rc._root.clone()), None)?.into();
        ...
        *self_rc.endorsement_security_deposit.borrow_mut() = t;
        let t = Self::read_into::<_, Id009PsflorenConstants_BakingRewardPerEndorsement>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        *self_rc.baking_reward_per_endorsement.borrow_mut() = t;
        let t = Self::read_into::<_, Id009PsflorenConstants_EndorsementReward>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
...
impl Id009PsflorenConstants {
    pub fn time_between_blocks(&self) -> Ref<OptRc<Id009PsflorenConstants_TimeBetweenBlocks>> {
...
impl Id009PsflorenConstants {
    pub fn hard_gas_limit_per_operation(&self) -> Ref<OptRc<Id009PsflorenConstants_Z>> {
        self.hard_gas_limit_per_operation.borrow()
    }
}
impl Id009PsflorenConstants {
    pub fn hard_gas_limit_per_block(&self) -> Ref<OptRc<Id009PsflorenConstants_Z>> {
...
impl Id009PsflorenConstants {
    pub fn tokens_per_roll(&self) -> Ref<OptRc<Id009PsflorenConstants_N>> {
...
impl Id009PsflorenConstants {
    pub fn seed_nonce_revelation_tip(&self) -> Ref<OptRc<Id009PsflorenConstants_N>> {
...
impl Id009PsflorenConstants {
    pub fn block_security_deposit(&self) -> Ref<OptRc<Id009PsflorenConstants_N>> {
        self.block_security_deposit.borrow()
    }
}
impl Id009PsflorenConstants {
    pub fn endorsement_security_deposit(&self) -> Ref<OptRc<Id009PsflorenConstants_N>> {
        self.endorsement_security_deposit.borrow()
    }
}
impl Id009PsflorenConstants {
    pub fn baking_reward_per_endorsement(&self) -> Ref<OptRc<Id009PsflorenConstants_BakingRewardPerEndorsement>> {
        self.baking_reward_per_endorsement.borrow()
    }
}
impl Id009PsflorenConstants {
    pub fn endorsement_reward(&self) -> Ref<OptRc<Id009PsflorenConstants_EndorsementReward>> {
        self.endorsement_reward.borrow()
    }
}
impl Id009PsflorenConstants {
    pub fn cost_per_byte(&self) -> Ref<OptRc<Id009PsflorenConstants_N>> {
        self.cost_per_byte.borrow()
    }
}
impl Id009PsflorenConstants {
    pub fn hard_storage_limit_per_operation(&self) -> Ref<OptRc<Id009PsflorenConstants_Z>> {
...
#[derive(Default, Debug, Clone)]
pub struct Id009PsflorenConstants_TimeBetweenBlocksEntries {
    pub _root: SharedType<Id009PsflorenConstants>,
    pub _parent: SharedType<Id009PsflorenConstants_TimeBetweenBlocks>,
    pub _self: SharedType<Self>,
    time_between_blocks_elt: RefCell<i64>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id009PsflorenConstants_TimeBetweenBlocksEntries {
    type Root = Id009PsflorenConstants;
    type Parent = Id009PsflorenConstants_TimeBetweenBlocks;
...
impl Id009PsflorenConstants_TimeBetweenBlocksEntries {
}
impl Id009PsflorenConstants_TimeBetweenBlocksEntries {
...
#[derive(Default, Debug, Clone)]
pub struct Id009PsflorenConstants_N {
    pub _root: SharedType<Id009PsflorenConstants>,
    pub _parent: SharedType<KStructUnit>,
    pub _self: SharedType<Self>,
    n: RefCell<Vec<OptRc<Id009PsflorenConstants_NChunk>>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id009PsflorenConstants_N {
    type Root = Id009PsflorenConstants;
        ...
        *self_rc.n.borrow_mut() = Vec::new();
        {
            let mut _i = 0;
            while {
                let t = Self::read_into::<_, Id009PsflorenConstants_NChunk>(&*_io, Some(self_rc._root.clone()), None)?.into();
...
impl Id009PsflorenConstants_N {
}
impl Id009PsflorenConstants_N {
    pub fn n(&self) -> Ref<Vec<OptRc<Id009PsflorenConstants_NChunk>>> {
        self.n.borrow()
    }
}
impl Id009PsflorenConstants_N {
...
#[derive(Default, Debug, Clone)]
pub struct Id009PsflorenConstants_TimeBetweenBlocks {
    pub _root: SharedType<Id009PsflorenConstants>,
    pub _parent: SharedType<Id009PsflorenConstants>,
    pub _self: SharedType<Self>,
    len_time_between_blocks: RefCell<i32>,
    time_between_blocks: RefCell<Vec<OptRc<Id009PsflorenConstants_TimeBetweenBlocksEntries>>>,
    _io: RefCell<BytesReader>,
    time_between_blocks_raw: RefCell<Vec<Vec<u8>>>,
}
impl KStruct for Id009PsflorenConstants_TimeBetweenBlocks {
    type Root = Id009PsflorenConstants;
    type Parent = Id009PsflorenConstants;
        ...
        *self_rc.time_between_blocks.borrow_mut() = Vec::new();
        {
            ...
            while !_io.is_eof() {
                ...
                let t = Self::read_into::<BytesReader, Id009PsflorenConstants_TimeBetweenBlocksEntries>(&io_time_between_blocks_raw, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
...
impl Id009PsflorenConstants_TimeBetweenBlocks {
}
impl Id009PsflorenConstants_TimeBetweenBlocks {
...
impl Id009PsflorenConstants_TimeBetweenBlocks {
    pub fn time_between_blocks(&self) -> Ref<Vec<OptRc<Id009PsflorenConstants_TimeBetweenBlocksEntries>>> {
        self.time_between_blocks.borrow()
    }
}
impl Id009PsflorenConstants_TimeBetweenBlocks {
...
#[derive(Default, Debug, Clone)]
pub struct Id009PsflorenConstants_EndorsementReward {
    pub _root: SharedType<Id009PsflorenConstants>,
    pub _parent: SharedType<Id009PsflorenConstants>,
    pub _self: SharedType<Self>,
    len_endorsement_reward: RefCell<i32>,
    endorsement_reward: RefCell<Vec<OptRc<Id009PsflorenConstants_EndorsementRewardEntries>>>,
    _io: RefCell<BytesReader>,
    endorsement_reward_raw: RefCell<Vec<Vec<u8>>>,
}
impl KStruct for Id009PsflorenConstants_EndorsementReward {
    type Root = Id009PsflorenConstants;
    type Parent = Id009PsflorenConstants;
        ...
        *self_rc.endorsement_reward.borrow_mut() = Vec::new();
        {
            ...
            while !_io.is_eof() {
                ...
                let t = Self::read_into::<BytesReader, Id009PsflorenConstants_EndorsementRewardEntries>(&io_endorsement_reward_raw, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
...
impl Id009PsflorenConstants_EndorsementReward {
}
impl Id009PsflorenConstants_EndorsementReward {
...
impl Id009PsflorenConstants_EndorsementReward {
    pub fn endorsement_reward(&self) -> Ref<Vec<OptRc<Id009PsflorenConstants_EndorsementRewardEntries>>> {
        self.endorsement_reward.borrow()
    }
}
impl Id009PsflorenConstants_EndorsementReward {
...
#[derive(Default, Debug, Clone)]
pub struct Id009PsflorenConstants_EndorsementRewardEntries {
    pub _root: SharedType<Id009PsflorenConstants>,
    pub _parent: SharedType<Id009PsflorenConstants_EndorsementReward>,
    pub _self: SharedType<Self>,
    id_009__psfloren__mutez: RefCell<OptRc<Id009PsflorenConstants_N>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id009PsflorenConstants_EndorsementRewardEntries {
    type Root = Id009PsflorenConstants;
    type Parent = Id009PsflorenConstants_EndorsementReward;
...
impl Id009PsflorenConstants_EndorsementRewardEntries {
}
impl Id009PsflorenConstants_EndorsementRewardEntries {
    pub fn id_009__psfloren__mutez(&self) -> Ref<OptRc<Id009PsflorenConstants_N>> {
...
#[derive(Default, Debug, Clone)]
pub struct Id009PsflorenConstants_BakingRewardPerEndorsement {
    pub _root: SharedType<Id009PsflorenConstants>,
    pub _parent: SharedType<Id009PsflorenConstants>,
    pub _self: SharedType<Self>,
    len_baking_reward_per_endorsement: RefCell<i32>,
    baking_reward_per_endorsement: RefCell<Vec<OptRc<Id009PsflorenConstants_BakingRewardPerEndorsementEntries>>>,
    _io: RefCell<BytesReader>,
    baking_reward_per_endorsement_raw: RefCell<Vec<Vec<u8>>>,
}
impl KStruct for Id009PsflorenConstants_BakingRewardPerEndorsement {
    type Root = Id009PsflorenConstants;
    type Parent = Id009PsflorenConstants;
        ...
        *self_rc.baking_reward_per_endorsement.borrow_mut() = Vec::new();
        {
            ...
            while !_io.is_eof() {
                ...
                let t = Self::read_into::<BytesReader, Id009PsflorenConstants_BakingRewardPerEndorsementEntries>(&io_baking_reward_per_endorsement_raw, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
...
impl Id009PsflorenConstants_BakingRewardPerEndorsement {
}
impl Id009PsflorenConstants_BakingRewardPerEndorsement {
...
impl Id009PsflorenConstants_BakingRewardPerEndorsement {
    pub fn baking_reward_per_endorsement(&self) -> Ref<Vec<OptRc<Id009PsflorenConstants_BakingRewardPerEndorsementEntries>>> {
        self.baking_reward_per_endorsement.borrow()
    }
}
impl Id009PsflorenConstants_BakingRewardPerEndorsement {
...
#[derive(Default, Debug, Clone)]
pub struct Id009PsflorenConstants_NChunk {
    pub _root: SharedType<Id009PsflorenConstants>,
    pub _parent: SharedType<KStructUnit>,
    pub _self: SharedType<Self>,
...
impl KStruct for Id009PsflorenConstants_NChunk {
    type Root = Id009PsflorenConstants;
    type Parent = KStructUnit;
...
impl Id009PsflorenConstants_NChunk {
}
impl Id009PsflorenConstants_NChunk {
...
#[derive(Default, Debug, Clone)]
pub struct Id009PsflorenConstants_Z {
    pub _root: SharedType<Id009PsflorenConstants>,
    pub _parent: SharedType<Id009PsflorenConstants>,
    pub _self: SharedType<Self>,
    ...
    sign: RefCell<bool>,
    payload: RefCell<u64>,
    tail: RefCell<Vec<OptRc<Id009PsflorenConstants_NChunk>>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id009PsflorenConstants_Z {
    type Root = Id009PsflorenConstants;
    type Parent = Id009PsflorenConstants;
...
impl Id009PsflorenConstants_Z {
    pub fn tail(&self) -> Ref<Vec<OptRc<Id009PsflorenConstants_NChunk>>> {
        self.tail.borrow()
    }
}
impl Id009PsflorenConstants_Z {
...
#[derive(Default, Debug, Clone)]
pub struct Id009PsflorenConstants_BakingRewardPerEndorsementEntries {
    pub _root: SharedType<Id009PsflorenConstants>,
    pub _parent: SharedType<Id009PsflorenConstants_BakingRewardPerEndorsement>,
    pub _self: SharedType<Self>,
    id_009__psfloren__mutez: RefCell<OptRc<Id009PsflorenConstants_N>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id009PsflorenConstants_BakingRewardPerEndorsementEntries {
    type Root = Id009PsflorenConstants;
    type Parent = Id009PsflorenConstants_BakingRewardPerEndorsement;
...
impl Id009PsflorenConstants_BakingRewardPerEndorsementEntries {
}
impl Id009PsflorenConstants_BakingRewardPerEndorsementEntries {
    pub fn id_009__psfloren__mutez(&self) -> Ref<OptRc<Id009PsflorenConstants_N>> {
        self.id_009__psfloren__mutez.borrow()
