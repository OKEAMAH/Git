...
pub struct Id011Pthangz2ScriptLoc {
    pub _root: SharedType<Id011Pthangz2ScriptLoc>,
    pub _parent: SharedType<Id011Pthangz2ScriptLoc>,
    pub _self: SharedType<Self>,
    micheline__location: RefCell<i32>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id011Pthangz2ScriptLoc {
    type Root = Id011Pthangz2ScriptLoc;
    type Parent = Id011Pthangz2ScriptLoc;
