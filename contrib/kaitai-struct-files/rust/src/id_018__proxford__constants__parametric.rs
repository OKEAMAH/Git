...
pub struct Id018ProxfordConstantsParametric {
    pub _root: SharedType<Id018ProxfordConstantsParametric>,
    pub _parent: SharedType<Id018ProxfordConstantsParametric>,
    ...
    hard_gas_limit_per_operation: RefCell<OptRc<Id018ProxfordConstantsParametric_Z>>,
    hard_gas_limit_per_block: RefCell<OptRc<Id018ProxfordConstantsParametric_Z>>,
    proof_of_work_threshold: RefCell<i64>,
    minimal_stake: RefCell<OptRc<Id018ProxfordConstantsParametric_N>>,
    minimal_frozen_stake: RefCell<OptRc<Id018ProxfordConstantsParametric_N>>,
    vdf_difficulty: RefCell<i64>,
    origination_size: RefCell<i32>,
    issuance_weights: RefCell<OptRc<Id018ProxfordConstantsParametric_IssuanceWeights>>,
    cost_per_byte: RefCell<OptRc<Id018ProxfordConstantsParametric_N>>,
    hard_storage_limit_per_operation: RefCell<OptRc<Id018ProxfordConstantsParametric_Z>>,
    ...
    minimal_participation_ratio: RefCell<OptRc<Id018ProxfordConstantsParametric_MinimalParticipationRatio>>,
    ...
    testnet_dictator_tag: RefCell<Id018ProxfordConstantsParametric_Bool>,
    testnet_dictator: RefCell<OptRc<Id018ProxfordConstantsParametric_PublicKeyHash>>,
    initial_seed_tag: RefCell<Id018ProxfordConstantsParametric_Bool>,
    ...
    dal_parametric: RefCell<OptRc<Id018ProxfordConstantsParametric_DalParametric>>,
    smart_rollup_enable: RefCell<Id018ProxfordConstantsParametric_Bool>,
    smart_rollup_arith_pvm_enable: RefCell<Id018ProxfordConstantsParametric_Bool>,
    smart_rollup_origination_size: RefCell<i32>,
    smart_rollup_challenge_window_in_blocks: RefCell<i32>,
    smart_rollup_stake_amount: RefCell<OptRc<Id018ProxfordConstantsParametric_N>>,
    ...
    smart_rollup_reveal_activation_level: RefCell<OptRc<Id018ProxfordConstantsParametric_SmartRollupRevealActivationLevel>>,
    zk_rollup_enable: RefCell<Id018ProxfordConstantsParametric_Bool>,
    ...
    adaptive_rewards_params: RefCell<OptRc<Id018ProxfordConstantsParametric_AdaptiveRewardsParams>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id018ProxfordConstantsParametric {
    type Root = Id018ProxfordConstantsParametric;
    type Parent = Id018ProxfordConstantsParametric;
    ...
    fn read<S: KStream>(
        ...
        *self_rc.cycles_per_voting_period.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id018ProxfordConstantsParametric_Z>(&*_io, Some(self_rc._root.clone()), None)?.into();
        ...
        *self_rc.proof_of_work_threshold.borrow_mut() = _io.read_s8be()?.into();
        let t = Self::read_into::<_, Id018ProxfordConstantsParametric_N>(&*_io, Some(self_rc._root.clone()), None)?.into();
        ...
        *self_rc.origination_size.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id018ProxfordConstantsParametric_IssuanceWeights>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.consensus_threshold.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id018ProxfordConstantsParametric_MinimalParticipationRatio>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.testnet_dictator_tag.borrow_mut() = (_io.read_u1()? as i64).try_into()?;
        if *self_rc.testnet_dictator_tag() == Id018ProxfordConstantsParametric_Bool::True {
            let t = Self::read_into::<_, Id018ProxfordConstantsParametric_PublicKeyHash>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
            *self_rc.testnet_dictator.borrow_mut() = t;
        }
        *self_rc.initial_seed_tag.borrow_mut() = (_io.read_u1()? as i64).try_into()?;
        if *self_rc.initial_seed_tag() == Id018ProxfordConstantsParametric_Bool::True {
        ...
        *self_rc.cache_sampler_state_cycles.borrow_mut() = _io.read_s1()?.into();
        let t = Self::read_into::<_, Id018ProxfordConstantsParametric_DalParametric>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.smart_rollup_max_number_of_parallel_games.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id018ProxfordConstantsParametric_SmartRollupRevealActivationLevel>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.adaptive_issuance_launch_ema_threshold.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id018ProxfordConstantsParametric_AdaptiveRewardsParams>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        *self_rc.adaptive_rewards_params.borrow_mut() = t;
        Ok(())
    }
}
impl Id018ProxfordConstantsParametric {
}
impl Id018ProxfordConstantsParametric {
...
impl Id018ProxfordConstantsParametric {
    pub fn hard_gas_limit_per_operation(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_Z>> {
        self.hard_gas_limit_per_operation.borrow()
    }
}
impl Id018ProxfordConstantsParametric {
    pub fn hard_gas_limit_per_block(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_Z>> {
...
impl Id018ProxfordConstantsParametric {
    pub fn minimal_stake(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_N>> {
        self.minimal_stake.borrow()
    }
}
impl Id018ProxfordConstantsParametric {
    pub fn minimal_frozen_stake(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_N>> {
...
impl Id018ProxfordConstantsParametric {
    pub fn issuance_weights(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_IssuanceWeights>> {
        self.issuance_weights.borrow()
    }
}
impl Id018ProxfordConstantsParametric {
    pub fn cost_per_byte(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_N>> {
        self.cost_per_byte.borrow()
    }
}
impl Id018ProxfordConstantsParametric {
    pub fn hard_storage_limit_per_operation(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_Z>> {
...
impl Id018ProxfordConstantsParametric {
    pub fn minimal_participation_ratio(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_MinimalParticipationRatio>> {
...
impl Id018ProxfordConstantsParametric {
    pub fn testnet_dictator_tag(&self) -> Ref<Id018ProxfordConstantsParametric_Bool> {
        self.testnet_dictator_tag.borrow()
    }
}
impl Id018ProxfordConstantsParametric {
    pub fn testnet_dictator(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_PublicKeyHash>> {
        self.testnet_dictator.borrow()
    }
}
impl Id018ProxfordConstantsParametric {
    pub fn initial_seed_tag(&self) -> Ref<Id018ProxfordConstantsParametric_Bool> {
...
impl Id018ProxfordConstantsParametric {
    pub fn dal_parametric(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_DalParametric>> {
        self.dal_parametric.borrow()
    }
}
impl Id018ProxfordConstantsParametric {
    pub fn smart_rollup_enable(&self) -> Ref<Id018ProxfordConstantsParametric_Bool> {
        self.smart_rollup_enable.borrow()
    }
}
impl Id018ProxfordConstantsParametric {
    pub fn smart_rollup_arith_pvm_enable(&self) -> Ref<Id018ProxfordConstantsParametric_Bool> {
...
impl Id018ProxfordConstantsParametric {
    pub fn smart_rollup_stake_amount(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_N>> {
...
impl Id018ProxfordConstantsParametric {
    pub fn smart_rollup_reveal_activation_level(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_SmartRollupRevealActivationLevel>> {
        self.smart_rollup_reveal_activation_level.borrow()
    }
}
impl Id018ProxfordConstantsParametric {
    pub fn zk_rollup_enable(&self) -> Ref<Id018ProxfordConstantsParametric_Bool> {
...
impl Id018ProxfordConstantsParametric {
    pub fn adaptive_rewards_params(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_AdaptiveRewardsParams>> {
...
pub enum Id018ProxfordConstantsParametric_PublicKeyHashTag {
    Ed25519,
    Secp256k1,
    P256,
    Bls,
...
impl TryFrom<i64> for Id018ProxfordConstantsParametric_PublicKeyHashTag {
    type Error = KError;
    fn try_from(flag: i64) -> KResult<Id018ProxfordConstantsParametric_PublicKeyHashTag> {
        match flag {
            0 => Ok(Id018ProxfordConstantsParametric_PublicKeyHashTag::Ed25519),
            1 => Ok(Id018ProxfordConstantsParametric_PublicKeyHashTag::Secp256k1),
            2 => Ok(Id018ProxfordConstantsParametric_PublicKeyHashTag::P256),
            3 => Ok(Id018ProxfordConstantsParametric_PublicKeyHashTag::Bls),
            _ => Ok(Id018ProxfordConstantsParametric_PublicKeyHashTag::Unknown(flag)),
        }
    }
}

impl From<&Id018ProxfordConstantsParametric_PublicKeyHashTag> for i64 {
    fn from(v: &Id018ProxfordConstantsParametric_PublicKeyHashTag) -> Self {
        match *v {
            Id018ProxfordConstantsParametric_PublicKeyHashTag::Ed25519 => 0,
            Id018ProxfordConstantsParametric_PublicKeyHashTag::Secp256k1 => 1,
            Id018ProxfordConstantsParametric_PublicKeyHashTag::P256 => 2,
            Id018ProxfordConstantsParametric_PublicKeyHashTag::Bls => 3,
            Id018ProxfordConstantsParametric_PublicKeyHashTag::Unknown(v) => v
        }
    }
}

impl Default for Id018ProxfordConstantsParametric_PublicKeyHashTag {
    fn default() -> Self { Id018ProxfordConstantsParametric_PublicKeyHashTag::Unknown(0) }
}

#[derive(Debug, PartialEq, Clone)]
pub enum Id018ProxfordConstantsParametric_Bool {
    False,
    True,
    Unknown(i64),
}

impl TryFrom<i64> for Id018ProxfordConstantsParametric_Bool {
    type Error = KError;
    fn try_from(flag: i64) -> KResult<Id018ProxfordConstantsParametric_Bool> {
        match flag {
            0 => Ok(Id018ProxfordConstantsParametric_Bool::False),
            255 => Ok(Id018ProxfordConstantsParametric_Bool::True),
            _ => Ok(Id018ProxfordConstantsParametric_Bool::Unknown(flag)),
        }
    }
}

impl From<&Id018ProxfordConstantsParametric_Bool> for i64 {
    fn from(v: &Id018ProxfordConstantsParametric_Bool) -> Self {
        match *v {
            Id018ProxfordConstantsParametric_Bool::False => 0,
            Id018ProxfordConstantsParametric_Bool::True => 255,
            Id018ProxfordConstantsParametric_Bool::Unknown(v) => v
        }
    }
}

impl Default for Id018ProxfordConstantsParametric_Bool {
    fn default() -> Self { Id018ProxfordConstantsParametric_Bool::Unknown(0) }
}


#[derive(Default, Debug, Clone)]
pub struct Id018ProxfordConstantsParametric_AdaptiveRewardsParams {
    pub _root: SharedType<Id018ProxfordConstantsParametric>,
    pub _parent: SharedType<Id018ProxfordConstantsParametric>,
    pub _self: SharedType<Self>,
    issuance_ratio_min: RefCell<OptRc<Id018ProxfordConstantsParametric_IssuanceRatioMin>>,
    issuance_ratio_max: RefCell<OptRc<Id018ProxfordConstantsParametric_IssuanceRatioMax>>,
    max_bonus: RefCell<i64>,
    growth_rate: RefCell<i64>,
    center_dz: RefCell<OptRc<Id018ProxfordConstantsParametric_CenterDz>>,
    radius_dz: RefCell<OptRc<Id018ProxfordConstantsParametric_RadiusDz>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id018ProxfordConstantsParametric_AdaptiveRewardsParams {
    type Root = Id018ProxfordConstantsParametric;
    type Parent = Id018ProxfordConstantsParametric;
    ...
    fn read<S: KStream>(
        ...
        *self_rc._io.borrow_mut() = _io.clone();
        ...
        let _prc = self_rc._parent.get_value().borrow().upgrade();
        let _r = _rrc.as_ref().unwrap();
        let t = Self::read_into::<_, Id018ProxfordConstantsParametric_IssuanceRatioMin>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        *self_rc.issuance_ratio_min.borrow_mut() = t;
        let t = Self::read_into::<_, Id018ProxfordConstantsParametric_IssuanceRatioMax>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.growth_rate.borrow_mut() = _io.read_s8be()?.into();
        let t = Self::read_into::<_, Id018ProxfordConstantsParametric_CenterDz>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        *self_rc.center_dz.borrow_mut() = t;
        let t = Self::read_into::<_, Id018ProxfordConstantsParametric_RadiusDz>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        *self_rc.radius_dz.borrow_mut() = t;
        Ok(())
    }
}
impl Id018ProxfordConstantsParametric_AdaptiveRewardsParams {
}
impl Id018ProxfordConstantsParametric_AdaptiveRewardsParams {
    pub fn issuance_ratio_min(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_IssuanceRatioMin>> {
        self.issuance_ratio_min.borrow()
    }
}
impl Id018ProxfordConstantsParametric_AdaptiveRewardsParams {
    pub fn issuance_ratio_max(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_IssuanceRatioMax>> {
...
impl Id018ProxfordConstantsParametric_AdaptiveRewardsParams {
    pub fn center_dz(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_CenterDz>> {
        self.center_dz.borrow()
    }
}
impl Id018ProxfordConstantsParametric_AdaptiveRewardsParams {
    pub fn radius_dz(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_RadiusDz>> {
...
#[derive(Default, Debug, Clone)]
pub struct Id018ProxfordConstantsParametric_CenterDz {
    pub _root: SharedType<Id018ProxfordConstantsParametric>,
    pub _parent: SharedType<Id018ProxfordConstantsParametric_AdaptiveRewardsParams>,
    pub _self: SharedType<Self>,
    numerator: RefCell<OptRc<Id018ProxfordConstantsParametric_Z>>,
    denominator: RefCell<OptRc<Id018ProxfordConstantsParametric_Z>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id018ProxfordConstantsParametric_CenterDz {
    type Root = Id018ProxfordConstantsParametric;
    type Parent = Id018ProxfordConstantsParametric_AdaptiveRewardsParams;
...
impl Id018ProxfordConstantsParametric_CenterDz {
}
impl Id018ProxfordConstantsParametric_CenterDz {
    pub fn numerator(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_Z>> {
        self.numerator.borrow()
    }
}
impl Id018ProxfordConstantsParametric_CenterDz {
    pub fn denominator(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_Z>> {
...
#[derive(Default, Debug, Clone)]
pub struct Id018ProxfordConstantsParametric_IssuanceWeights {
    pub _root: SharedType<Id018ProxfordConstantsParametric>,
    pub _parent: SharedType<Id018ProxfordConstantsParametric>,
    pub _self: SharedType<Self>,
    base_total_issued_per_minute: RefCell<OptRc<Id018ProxfordConstantsParametric_N>>,
...
impl KStruct for Id018ProxfordConstantsParametric_IssuanceWeights {
    type Root = Id018ProxfordConstantsParametric;
    type Parent = Id018ProxfordConstantsParametric;
...
impl Id018ProxfordConstantsParametric_IssuanceWeights {
}
impl Id018ProxfordConstantsParametric_IssuanceWeights {
    pub fn base_total_issued_per_minute(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_N>> {
...
#[derive(Default, Debug, Clone)]
pub struct Id018ProxfordConstantsParametric_DalParametric {
    pub _root: SharedType<Id018ProxfordConstantsParametric>,
    pub _parent: SharedType<Id018ProxfordConstantsParametric>,
    pub _self: SharedType<Self>,
    feature_enable: RefCell<Id018ProxfordConstantsParametric_Bool>,
...
impl KStruct for Id018ProxfordConstantsParametric_DalParametric {
    type Root = Id018ProxfordConstantsParametric;
    type Parent = Id018ProxfordConstantsParametric;
...
impl Id018ProxfordConstantsParametric_DalParametric {
}
impl Id018ProxfordConstantsParametric_DalParametric {
    pub fn feature_enable(&self) -> Ref<Id018ProxfordConstantsParametric_Bool> {
...
#[derive(Default, Debug, Clone)]
pub struct Id018ProxfordConstantsParametric_N {
    pub _root: SharedType<Id018ProxfordConstantsParametric>,
    pub _parent: SharedType<KStructUnit>,
    pub _self: SharedType<Self>,
    n: RefCell<Vec<OptRc<Id018ProxfordConstantsParametric_NChunk>>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id018ProxfordConstantsParametric_N {
    type Root = Id018ProxfordConstantsParametric;
        ...
        *self_rc.n.borrow_mut() = Vec::new();
        {
            let mut _i = 0;
            while {
                let t = Self::read_into::<_, Id018ProxfordConstantsParametric_NChunk>(&*_io, Some(self_rc._root.clone()), None)?.into();
...
impl Id018ProxfordConstantsParametric_N {
}
impl Id018ProxfordConstantsParametric_N {
    pub fn n(&self) -> Ref<Vec<OptRc<Id018ProxfordConstantsParametric_NChunk>>> {
        self.n.borrow()
    }
}
impl Id018ProxfordConstantsParametric_N {
...
#[derive(Default, Debug, Clone)]
pub struct Id018ProxfordConstantsParametric_IssuanceRatioMin {
    pub _root: SharedType<Id018ProxfordConstantsParametric>,
    pub _parent: SharedType<Id018ProxfordConstantsParametric_AdaptiveRewardsParams>,
    pub _self: SharedType<Self>,
    numerator: RefCell<OptRc<Id018ProxfordConstantsParametric_Z>>,
...
impl KStruct for Id018ProxfordConstantsParametric_IssuanceRatioMin {
    type Root = Id018ProxfordConstantsParametric;
    type Parent = Id018ProxfordConstantsParametric_AdaptiveRewardsParams;
...
impl Id018ProxfordConstantsParametric_IssuanceRatioMin {
}
impl Id018ProxfordConstantsParametric_IssuanceRatioMin {
    pub fn numerator(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_Z>> {
        self.numerator.borrow()
...
#[derive(Default, Debug, Clone)]
pub struct Id018ProxfordConstantsParametric_IssuanceRatioMax {
    pub _root: SharedType<Id018ProxfordConstantsParametric>,
    pub _parent: SharedType<Id018ProxfordConstantsParametric_AdaptiveRewardsParams>,
    pub _self: SharedType<Self>,
    numerator: RefCell<OptRc<Id018ProxfordConstantsParametric_Z>>,
...
impl KStruct for Id018ProxfordConstantsParametric_IssuanceRatioMax {
    type Root = Id018ProxfordConstantsParametric;
    type Parent = Id018ProxfordConstantsParametric_AdaptiveRewardsParams;
...
impl Id018ProxfordConstantsParametric_IssuanceRatioMax {
}
impl Id018ProxfordConstantsParametric_IssuanceRatioMax {
    pub fn numerator(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_Z>> {
        self.numerator.borrow()
...
#[derive(Default, Debug, Clone)]
pub struct Id018ProxfordConstantsParametric_MinimalParticipationRatio {
    pub _root: SharedType<Id018ProxfordConstantsParametric>,
    pub _parent: SharedType<Id018ProxfordConstantsParametric>,
    pub _self: SharedType<Self>,
...
impl KStruct for Id018ProxfordConstantsParametric_MinimalParticipationRatio {
    type Root = Id018ProxfordConstantsParametric;
    type Parent = Id018ProxfordConstantsParametric;
...
impl Id018ProxfordConstantsParametric_MinimalParticipationRatio {
}
impl Id018ProxfordConstantsParametric_MinimalParticipationRatio {
...
#[derive(Default, Debug, Clone)]
pub struct Id018ProxfordConstantsParametric_SmartRollupRevealActivationLevel {
    pub _root: SharedType<Id018ProxfordConstantsParametric>,
    pub _parent: SharedType<Id018ProxfordConstantsParametric>,
    pub _self: SharedType<Self>,
...
impl KStruct for Id018ProxfordConstantsParametric_SmartRollupRevealActivationLevel {
    type Root = Id018ProxfordConstantsParametric;
    type Parent = Id018ProxfordConstantsParametric;
...
impl Id018ProxfordConstantsParametric_SmartRollupRevealActivationLevel {
}
impl Id018ProxfordConstantsParametric_SmartRollupRevealActivationLevel {
...
#[derive(Default, Debug, Clone)]
pub struct Id018ProxfordConstantsParametric_RadiusDz {
    pub _root: SharedType<Id018ProxfordConstantsParametric>,
    pub _parent: SharedType<Id018ProxfordConstantsParametric_AdaptiveRewardsParams>,
    pub _self: SharedType<Self>,
    numerator: RefCell<OptRc<Id018ProxfordConstantsParametric_Z>>,
...
impl KStruct for Id018ProxfordConstantsParametric_RadiusDz {
    type Root = Id018ProxfordConstantsParametric;
    type Parent = Id018ProxfordConstantsParametric_AdaptiveRewardsParams;
...
impl Id018ProxfordConstantsParametric_RadiusDz {
}
impl Id018ProxfordConstantsParametric_RadiusDz {
    pub fn numerator(&self) -> Ref<OptRc<Id018ProxfordConstantsParametric_Z>> {
        self.numerator.borrow()
...
#[derive(Default, Debug, Clone)]
pub struct Id018ProxfordConstantsParametric_NChunk {
    pub _root: SharedType<Id018ProxfordConstantsParametric>,
    pub _parent: SharedType<KStructUnit>,
    pub _self: SharedType<Self>,
...
impl KStruct for Id018ProxfordConstantsParametric_NChunk {
    type Root = Id018ProxfordConstantsParametric;
    type Parent = KStructUnit;
...
impl Id018ProxfordConstantsParametric_NChunk {
}
impl Id018ProxfordConstantsParametric_NChunk {
...
#[derive(Default, Debug, Clone)]
pub struct Id018ProxfordConstantsParametric_PublicKeyHash {
    pub _root: SharedType<Id018ProxfordConstantsParametric>,
    pub _parent: SharedType<Id018ProxfordConstantsParametric>,
    pub _self: SharedType<Self>,
    public_key_hash_tag: RefCell<Id018ProxfordConstantsParametric_PublicKeyHashTag>,
...
impl KStruct for Id018ProxfordConstantsParametric_PublicKeyHash {
    type Root = Id018ProxfordConstantsParametric;
    type Parent = Id018ProxfordConstantsParametric;
    ...
    fn read<S: KStream>(
        ...
        *self_rc.public_key_hash_tag.borrow_mut() = (_io.read_u1()? as i64).try_into()?;
        if *self_rc.public_key_hash_tag() == Id018ProxfordConstantsParametric_PublicKeyHashTag::Ed25519 {
            *self_rc.public_key_hash_ed25519.borrow_mut() = _io.read_bytes(20 as usize)?.into();
        }
        if *self_rc.public_key_hash_tag() == Id018ProxfordConstantsParametric_PublicKeyHashTag::Secp256k1 {
            *self_rc.public_key_hash_secp256k1.borrow_mut() = _io.read_bytes(20 as usize)?.into();
        }
        if *self_rc.public_key_hash_tag() == Id018ProxfordConstantsParametric_PublicKeyHashTag::P256 {
            *self_rc.public_key_hash_p256.borrow_mut() = _io.read_bytes(20 as usize)?.into();
        }
        if *self_rc.public_key_hash_tag() == Id018ProxfordConstantsParametric_PublicKeyHashTag::Bls {
            *self_rc.public_key_hash_bls.borrow_mut() = _io.read_bytes(20 as usize)?.into();
        }
        Ok(())
    }
}
impl Id018ProxfordConstantsParametric_PublicKeyHash {
}
impl Id018ProxfordConstantsParametric_PublicKeyHash {
    pub fn public_key_hash_tag(&self) -> Ref<Id018ProxfordConstantsParametric_PublicKeyHashTag> {
...
#[derive(Default, Debug, Clone)]
pub struct Id018ProxfordConstantsParametric_Z {
    pub _root: SharedType<Id018ProxfordConstantsParametric>,
    pub _parent: SharedType<KStructUnit>,
    pub _self: SharedType<Self>,
    ...
    sign: RefCell<bool>,
    payload: RefCell<u64>,
    tail: RefCell<Vec<OptRc<Id018ProxfordConstantsParametric_NChunk>>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id018ProxfordConstantsParametric_Z {
    type Root = Id018ProxfordConstantsParametric;
    type Parent = KStructUnit;
...
impl Id018ProxfordConstantsParametric_Z {
}
impl Id018ProxfordConstantsParametric_Z {
...
impl Id018ProxfordConstantsParametric_Z {
    pub fn tail(&self) -> Ref<Vec<OptRc<Id018ProxfordConstantsParametric_NChunk>>> {
        self.tail.borrow()
    }
}
impl Id018ProxfordConstantsParametric_Z {
