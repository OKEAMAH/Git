...
pub struct Id011Pthangz2ConstantsFixed {
    pub _root: SharedType<Id011Pthangz2ConstantsFixed>,
    pub _parent: SharedType<Id011Pthangz2ConstantsFixed>,
    ...
    cache_layout: RefCell<OptRc<Id011Pthangz2ConstantsFixed_CacheLayout>>,
    michelson_maximum_type_size: RefCell<u16>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id011Pthangz2ConstantsFixed {
    type Root = Id011Pthangz2ConstantsFixed;
    type Parent = Id011Pthangz2ConstantsFixed;
    ...
    fn read<S: KStream>(
        ...
        *self_rc.max_allowed_global_constants_depth.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id011Pthangz2ConstantsFixed_CacheLayout>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        *self_rc.cache_layout.borrow_mut() = t;
        *self_rc.michelson_maximum_type_size.borrow_mut() = _io.read_u2be()?.into();
        Ok(())
    }
}
impl Id011Pthangz2ConstantsFixed {
}
impl Id011Pthangz2ConstantsFixed {
...
impl Id011Pthangz2ConstantsFixed {
    pub fn cache_layout(&self) -> Ref<OptRc<Id011Pthangz2ConstantsFixed_CacheLayout>> {
...
#[derive(Default, Debug, Clone)]
pub struct Id011Pthangz2ConstantsFixed_CacheLayout {
    pub _root: SharedType<Id011Pthangz2ConstantsFixed>,
    pub _parent: SharedType<Id011Pthangz2ConstantsFixed>,
    pub _self: SharedType<Self>,
    len_cache_layout: RefCell<i32>,
    cache_layout: RefCell<Vec<OptRc<Id011Pthangz2ConstantsFixed_CacheLayoutEntries>>>,
    _io: RefCell<BytesReader>,
    cache_layout_raw: RefCell<Vec<Vec<u8>>>,
}
impl KStruct for Id011Pthangz2ConstantsFixed_CacheLayout {
    type Root = Id011Pthangz2ConstantsFixed;
    type Parent = Id011Pthangz2ConstantsFixed;
        ...
        *self_rc.cache_layout.borrow_mut() = Vec::new();
        {
            ...
            while !_io.is_eof() {
                ...
                let t = Self::read_into::<BytesReader, Id011Pthangz2ConstantsFixed_CacheLayoutEntries>(&io_cache_layout_raw, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
...
impl Id011Pthangz2ConstantsFixed_CacheLayout {
}
impl Id011Pthangz2ConstantsFixed_CacheLayout {
...
impl Id011Pthangz2ConstantsFixed_CacheLayout {
    pub fn cache_layout(&self) -> Ref<Vec<OptRc<Id011Pthangz2ConstantsFixed_CacheLayoutEntries>>> {
        self.cache_layout.borrow()
    }
}
impl Id011Pthangz2ConstantsFixed_CacheLayout {
...
#[derive(Default, Debug, Clone)]
pub struct Id011Pthangz2ConstantsFixed_CacheLayoutEntries {
    pub _root: SharedType<Id011Pthangz2ConstantsFixed>,
    pub _parent: SharedType<Id011Pthangz2ConstantsFixed_CacheLayout>,
    pub _self: SharedType<Self>,
    cache_layout_elt: RefCell<i64>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id011Pthangz2ConstantsFixed_CacheLayoutEntries {
    type Root = Id011Pthangz2ConstantsFixed;
    type Parent = Id011Pthangz2ConstantsFixed_CacheLayout;
...
impl Id011Pthangz2ConstantsFixed_CacheLayoutEntries {
}
impl Id011Pthangz2ConstantsFixed_CacheLayoutEntries {
