...
pub struct Id005Psbabym1Level {
    pub _root: SharedType<Id005Psbabym1Level>,
    pub _parent: SharedType<Id005Psbabym1Level>,
    ...
    expected_commitment: RefCell<Id005Psbabym1Level_Bool>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id005Psbabym1Level {
    type Root = Id005Psbabym1Level;
    type Parent = Id005Psbabym1Level;
 ...
 */
impl Id005Psbabym1Level {
    pub fn expected_commitment(&self) -> Ref<Id005Psbabym1Level_Bool> {
...
pub enum Id005Psbabym1Level_Bool {
    False,
    True,
    Unknown(i64),
}

impl TryFrom<i64> for Id005Psbabym1Level_Bool {
    type Error = KError;
    fn try_from(flag: i64) -> KResult<Id005Psbabym1Level_Bool> {
        match flag {
            0 => Ok(Id005Psbabym1Level_Bool::False),
            255 => Ok(Id005Psbabym1Level_Bool::True),
            _ => Ok(Id005Psbabym1Level_Bool::Unknown(flag)),
        }
    }
}

impl From<&Id005Psbabym1Level_Bool> for i64 {
    fn from(v: &Id005Psbabym1Level_Bool) -> Self {
        match *v {
            Id005Psbabym1Level_Bool::False => 0,
            Id005Psbabym1Level_Bool::True => 255,
            Id005Psbabym1Level_Bool::Unknown(v) => v
        }
    }
}

impl Default for Id005Psbabym1Level_Bool {
    fn default() -> Self { Id005Psbabym1Level_Bool::Unknown(0) }
}
