...
pub struct Id008Ptedo2zkScriptLoc {
    pub _root: SharedType<Id008Ptedo2zkScriptLoc>,
    pub _parent: SharedType<Id008Ptedo2zkScriptLoc>,
    pub _self: SharedType<Self>,
    micheline__location: RefCell<i32>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id008Ptedo2zkScriptLoc {
    type Root = Id008Ptedo2zkScriptLoc;
    type Parent = Id008Ptedo2zkScriptLoc;
