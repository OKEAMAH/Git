...
pub struct Id014PtkathmaScriptLoc {
    pub _root: SharedType<Id014PtkathmaScriptLoc>,
    pub _parent: SharedType<Id014PtkathmaScriptLoc>,
    pub _self: SharedType<Self>,
    micheline__location: RefCell<i32>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id014PtkathmaScriptLoc {
    type Root = Id014PtkathmaScriptLoc;
    type Parent = Id014PtkathmaScriptLoc;
