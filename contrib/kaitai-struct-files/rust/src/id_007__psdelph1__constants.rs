...
pub struct Id007Psdelph1Constants {
    pub _root: SharedType<Id007Psdelph1Constants>,
    pub _parent: SharedType<Id007Psdelph1Constants>,
    ...
    time_between_blocks: RefCell<OptRc<Id007Psdelph1Constants_TimeBetweenBlocks>>,
    endorsers_per_block: RefCell<u16>,
    hard_gas_limit_per_operation: RefCell<OptRc<Id007Psdelph1Constants_Z>>,
    hard_gas_limit_per_block: RefCell<OptRc<Id007Psdelph1Constants_Z>>,
    proof_of_work_threshold: RefCell<i64>,
    tokens_per_roll: RefCell<OptRc<Id007Psdelph1Constants_N>>,
    michelson_maximum_type_size: RefCell<u16>,
    seed_nonce_revelation_tip: RefCell<OptRc<Id007Psdelph1Constants_N>>,
    origination_size: RefCell<i32>,
    block_security_deposit: RefCell<OptRc<Id007Psdelph1Constants_N>>,
    endorsement_security_deposit: RefCell<OptRc<Id007Psdelph1Constants_N>>,
    baking_reward_per_endorsement: RefCell<OptRc<Id007Psdelph1Constants_BakingRewardPerEndorsement>>,
    endorsement_reward: RefCell<OptRc<Id007Psdelph1Constants_EndorsementReward>>,
    cost_per_byte: RefCell<OptRc<Id007Psdelph1Constants_N>>,
    hard_storage_limit_per_operation: RefCell<OptRc<Id007Psdelph1Constants_Z>>,
...
impl KStruct for Id007Psdelph1Constants {
    type Root = Id007Psdelph1Constants;
    type Parent = Id007Psdelph1Constants;
    ...
    fn read<S: KStream>(
        ...
        *self_rc.blocks_per_voting_period.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id007Psdelph1Constants_TimeBetweenBlocks>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        *self_rc.time_between_blocks.borrow_mut() = t;
        *self_rc.endorsers_per_block.borrow_mut() = _io.read_u2be()?.into();
        let t = Self::read_into::<_, Id007Psdelph1Constants_Z>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.proof_of_work_threshold.borrow_mut() = _io.read_s8be()?.into();
        let t = Self::read_into::<_, Id007Psdelph1Constants_N>(&*_io, Some(self_rc._root.clone()), None)?.into();
        ...
        *self_rc.endorsement_security_deposit.borrow_mut() = t;
        let t = Self::read_into::<_, Id007Psdelph1Constants_BakingRewardPerEndorsement>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        *self_rc.baking_reward_per_endorsement.borrow_mut() = t;
        let t = Self::read_into::<_, Id007Psdelph1Constants_EndorsementReward>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
...
impl Id007Psdelph1Constants {
    pub fn time_between_blocks(&self) -> Ref<OptRc<Id007Psdelph1Constants_TimeBetweenBlocks>> {
...
impl Id007Psdelph1Constants {
    pub fn hard_gas_limit_per_operation(&self) -> Ref<OptRc<Id007Psdelph1Constants_Z>> {
        self.hard_gas_limit_per_operation.borrow()
    }
}
impl Id007Psdelph1Constants {
    pub fn hard_gas_limit_per_block(&self) -> Ref<OptRc<Id007Psdelph1Constants_Z>> {
...
impl Id007Psdelph1Constants {
    pub fn tokens_per_roll(&self) -> Ref<OptRc<Id007Psdelph1Constants_N>> {
...
impl Id007Psdelph1Constants {
    pub fn seed_nonce_revelation_tip(&self) -> Ref<OptRc<Id007Psdelph1Constants_N>> {
...
impl Id007Psdelph1Constants {
    pub fn block_security_deposit(&self) -> Ref<OptRc<Id007Psdelph1Constants_N>> {
        self.block_security_deposit.borrow()
    }
}
impl Id007Psdelph1Constants {
    pub fn endorsement_security_deposit(&self) -> Ref<OptRc<Id007Psdelph1Constants_N>> {
        self.endorsement_security_deposit.borrow()
    }
}
impl Id007Psdelph1Constants {
    pub fn baking_reward_per_endorsement(&self) -> Ref<OptRc<Id007Psdelph1Constants_BakingRewardPerEndorsement>> {
        self.baking_reward_per_endorsement.borrow()
    }
}
impl Id007Psdelph1Constants {
    pub fn endorsement_reward(&self) -> Ref<OptRc<Id007Psdelph1Constants_EndorsementReward>> {
        self.endorsement_reward.borrow()
    }
}
impl Id007Psdelph1Constants {
    pub fn cost_per_byte(&self) -> Ref<OptRc<Id007Psdelph1Constants_N>> {
        self.cost_per_byte.borrow()
    }
}
impl Id007Psdelph1Constants {
    pub fn hard_storage_limit_per_operation(&self) -> Ref<OptRc<Id007Psdelph1Constants_Z>> {
...
#[derive(Default, Debug, Clone)]
pub struct Id007Psdelph1Constants_TimeBetweenBlocksEntries {
    pub _root: SharedType<Id007Psdelph1Constants>,
    pub _parent: SharedType<Id007Psdelph1Constants_TimeBetweenBlocks>,
    pub _self: SharedType<Self>,
    time_between_blocks_elt: RefCell<i64>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id007Psdelph1Constants_TimeBetweenBlocksEntries {
    type Root = Id007Psdelph1Constants;
    type Parent = Id007Psdelph1Constants_TimeBetweenBlocks;
...
impl Id007Psdelph1Constants_TimeBetweenBlocksEntries {
}
impl Id007Psdelph1Constants_TimeBetweenBlocksEntries {
...
#[derive(Default, Debug, Clone)]
pub struct Id007Psdelph1Constants_N {
    pub _root: SharedType<Id007Psdelph1Constants>,
    pub _parent: SharedType<KStructUnit>,
    pub _self: SharedType<Self>,
    n: RefCell<Vec<OptRc<Id007Psdelph1Constants_NChunk>>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id007Psdelph1Constants_N {
    type Root = Id007Psdelph1Constants;
        ...
        *self_rc.n.borrow_mut() = Vec::new();
        {
            let mut _i = 0;
            while {
                let t = Self::read_into::<_, Id007Psdelph1Constants_NChunk>(&*_io, Some(self_rc._root.clone()), None)?.into();
...
impl Id007Psdelph1Constants_N {
}
impl Id007Psdelph1Constants_N {
    pub fn n(&self) -> Ref<Vec<OptRc<Id007Psdelph1Constants_NChunk>>> {
        self.n.borrow()
    }
}
impl Id007Psdelph1Constants_N {
...
#[derive(Default, Debug, Clone)]
pub struct Id007Psdelph1Constants_TimeBetweenBlocks {
    pub _root: SharedType<Id007Psdelph1Constants>,
    pub _parent: SharedType<Id007Psdelph1Constants>,
    pub _self: SharedType<Self>,
    len_time_between_blocks: RefCell<i32>,
    time_between_blocks: RefCell<Vec<OptRc<Id007Psdelph1Constants_TimeBetweenBlocksEntries>>>,
    _io: RefCell<BytesReader>,
    time_between_blocks_raw: RefCell<Vec<Vec<u8>>>,
}
impl KStruct for Id007Psdelph1Constants_TimeBetweenBlocks {
    type Root = Id007Psdelph1Constants;
    type Parent = Id007Psdelph1Constants;
        ...
        *self_rc.time_between_blocks.borrow_mut() = Vec::new();
        {
            ...
            while !_io.is_eof() {
                ...
                let t = Self::read_into::<BytesReader, Id007Psdelph1Constants_TimeBetweenBlocksEntries>(&io_time_between_blocks_raw, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
...
impl Id007Psdelph1Constants_TimeBetweenBlocks {
}
impl Id007Psdelph1Constants_TimeBetweenBlocks {
...
impl Id007Psdelph1Constants_TimeBetweenBlocks {
    pub fn time_between_blocks(&self) -> Ref<Vec<OptRc<Id007Psdelph1Constants_TimeBetweenBlocksEntries>>> {
        self.time_between_blocks.borrow()
    }
}
impl Id007Psdelph1Constants_TimeBetweenBlocks {
...
#[derive(Default, Debug, Clone)]
pub struct Id007Psdelph1Constants_EndorsementReward {
    pub _root: SharedType<Id007Psdelph1Constants>,
    pub _parent: SharedType<Id007Psdelph1Constants>,
    pub _self: SharedType<Self>,
    len_endorsement_reward: RefCell<i32>,
    endorsement_reward: RefCell<Vec<OptRc<Id007Psdelph1Constants_EndorsementRewardEntries>>>,
    _io: RefCell<BytesReader>,
    endorsement_reward_raw: RefCell<Vec<Vec<u8>>>,
}
impl KStruct for Id007Psdelph1Constants_EndorsementReward {
    type Root = Id007Psdelph1Constants;
    type Parent = Id007Psdelph1Constants;
        ...
        *self_rc.endorsement_reward.borrow_mut() = Vec::new();
        {
            ...
            while !_io.is_eof() {
                ...
                let t = Self::read_into::<BytesReader, Id007Psdelph1Constants_EndorsementRewardEntries>(&io_endorsement_reward_raw, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
...
impl Id007Psdelph1Constants_EndorsementReward {
}
impl Id007Psdelph1Constants_EndorsementReward {
...
impl Id007Psdelph1Constants_EndorsementReward {
    pub fn endorsement_reward(&self) -> Ref<Vec<OptRc<Id007Psdelph1Constants_EndorsementRewardEntries>>> {
        self.endorsement_reward.borrow()
    }
}
impl Id007Psdelph1Constants_EndorsementReward {
...
#[derive(Default, Debug, Clone)]
pub struct Id007Psdelph1Constants_EndorsementRewardEntries {
    pub _root: SharedType<Id007Psdelph1Constants>,
    pub _parent: SharedType<Id007Psdelph1Constants_EndorsementReward>,
    pub _self: SharedType<Self>,
    id_007__psdelph1__mutez: RefCell<OptRc<Id007Psdelph1Constants_N>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id007Psdelph1Constants_EndorsementRewardEntries {
    type Root = Id007Psdelph1Constants;
    type Parent = Id007Psdelph1Constants_EndorsementReward;
...
impl Id007Psdelph1Constants_EndorsementRewardEntries {
}
impl Id007Psdelph1Constants_EndorsementRewardEntries {
    pub fn id_007__psdelph1__mutez(&self) -> Ref<OptRc<Id007Psdelph1Constants_N>> {
...
#[derive(Default, Debug, Clone)]
pub struct Id007Psdelph1Constants_BakingRewardPerEndorsement {
    pub _root: SharedType<Id007Psdelph1Constants>,
    pub _parent: SharedType<Id007Psdelph1Constants>,
    pub _self: SharedType<Self>,
    len_baking_reward_per_endorsement: RefCell<i32>,
    baking_reward_per_endorsement: RefCell<Vec<OptRc<Id007Psdelph1Constants_BakingRewardPerEndorsementEntries>>>,
    _io: RefCell<BytesReader>,
    baking_reward_per_endorsement_raw: RefCell<Vec<Vec<u8>>>,
}
impl KStruct for Id007Psdelph1Constants_BakingRewardPerEndorsement {
    type Root = Id007Psdelph1Constants;
    type Parent = Id007Psdelph1Constants;
        ...
        *self_rc.baking_reward_per_endorsement.borrow_mut() = Vec::new();
        {
            ...
            while !_io.is_eof() {
                ...
                let t = Self::read_into::<BytesReader, Id007Psdelph1Constants_BakingRewardPerEndorsementEntries>(&io_baking_reward_per_endorsement_raw, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
...
impl Id007Psdelph1Constants_BakingRewardPerEndorsement {
}
impl Id007Psdelph1Constants_BakingRewardPerEndorsement {
...
impl Id007Psdelph1Constants_BakingRewardPerEndorsement {
    pub fn baking_reward_per_endorsement(&self) -> Ref<Vec<OptRc<Id007Psdelph1Constants_BakingRewardPerEndorsementEntries>>> {
        self.baking_reward_per_endorsement.borrow()
    }
}
impl Id007Psdelph1Constants_BakingRewardPerEndorsement {
...
#[derive(Default, Debug, Clone)]
pub struct Id007Psdelph1Constants_NChunk {
    pub _root: SharedType<Id007Psdelph1Constants>,
    pub _parent: SharedType<KStructUnit>,
    pub _self: SharedType<Self>,
...
impl KStruct for Id007Psdelph1Constants_NChunk {
    type Root = Id007Psdelph1Constants;
    type Parent = KStructUnit;
...
impl Id007Psdelph1Constants_NChunk {
}
impl Id007Psdelph1Constants_NChunk {
...
#[derive(Default, Debug, Clone)]
pub struct Id007Psdelph1Constants_Z {
    pub _root: SharedType<Id007Psdelph1Constants>,
    pub _parent: SharedType<Id007Psdelph1Constants>,
    pub _self: SharedType<Self>,
    ...
    sign: RefCell<bool>,
    payload: RefCell<u64>,
    tail: RefCell<Vec<OptRc<Id007Psdelph1Constants_NChunk>>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id007Psdelph1Constants_Z {
    type Root = Id007Psdelph1Constants;
    type Parent = Id007Psdelph1Constants;
...
impl Id007Psdelph1Constants_Z {
    pub fn tail(&self) -> Ref<Vec<OptRc<Id007Psdelph1Constants_NChunk>>> {
        self.tail.borrow()
    }
}
impl Id007Psdelph1Constants_Z {
...
#[derive(Default, Debug, Clone)]
pub struct Id007Psdelph1Constants_BakingRewardPerEndorsementEntries {
    pub _root: SharedType<Id007Psdelph1Constants>,
    pub _parent: SharedType<Id007Psdelph1Constants_BakingRewardPerEndorsement>,
    pub _self: SharedType<Self>,
    id_007__psdelph1__mutez: RefCell<OptRc<Id007Psdelph1Constants_N>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id007Psdelph1Constants_BakingRewardPerEndorsementEntries {
    type Root = Id007Psdelph1Constants;
    type Parent = Id007Psdelph1Constants_BakingRewardPerEndorsement;
...
impl Id007Psdelph1Constants_BakingRewardPerEndorsementEntries {
}
impl Id007Psdelph1Constants_BakingRewardPerEndorsementEntries {
    pub fn id_007__psdelph1__mutez(&self) -> Ref<OptRc<Id007Psdelph1Constants_N>> {
        self.id_007__psdelph1__mutez.borrow()
