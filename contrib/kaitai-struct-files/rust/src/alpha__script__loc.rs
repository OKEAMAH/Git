...
pub struct AlphaScriptLoc {
    pub _root: SharedType<AlphaScriptLoc>,
    pub _parent: SharedType<AlphaScriptLoc>,
    pub _self: SharedType<Self>,
    micheline__location: RefCell<i32>,
    _io: RefCell<BytesReader>,
}
impl KStruct for AlphaScriptLoc {
    type Root = AlphaScriptLoc;
    type Parent = AlphaScriptLoc;
