...
pub struct Id015PtlimaptLevel {
    pub _root: SharedType<Id015PtlimaptLevel>,
    pub _parent: SharedType<Id015PtlimaptLevel>,
    pub _self: SharedType<Self>,
    level: RefCell<i32>,
    level_position: RefCell<i32>,
    cycle: RefCell<i32>,
    cycle_position: RefCell<i32>,
    expected_commitment: RefCell<Id015PtlimaptLevel_Bool>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id015PtlimaptLevel {
    type Root = Id015PtlimaptLevel;
    type Parent = Id015PtlimaptLevel;
 ...
 */
impl Id015PtlimaptLevel {
    pub fn expected_commitment(&self) -> Ref<Id015PtlimaptLevel_Bool> {
...
pub enum Id015PtlimaptLevel_Bool {
    False,
    True,
    Unknown(i64),
}

impl TryFrom<i64> for Id015PtlimaptLevel_Bool {
    type Error = KError;
    fn try_from(flag: i64) -> KResult<Id015PtlimaptLevel_Bool> {
        match flag {
            0 => Ok(Id015PtlimaptLevel_Bool::False),
            255 => Ok(Id015PtlimaptLevel_Bool::True),
            _ => Ok(Id015PtlimaptLevel_Bool::Unknown(flag)),
        }
    }
}

impl From<&Id015PtlimaptLevel_Bool> for i64 {
    fn from(v: &Id015PtlimaptLevel_Bool) -> Self {
        match *v {
            Id015PtlimaptLevel_Bool::False => 0,
            Id015PtlimaptLevel_Bool::True => 255,
            Id015PtlimaptLevel_Bool::Unknown(v) => v
        }
    }
}

impl Default for Id015PtlimaptLevel_Bool {
    fn default() -> Self { Id015PtlimaptLevel_Bool::Unknown(0) }
}
