...
pub struct Id008Ptedo2zkLevel {
    pub _root: SharedType<Id008Ptedo2zkLevel>,
    pub _parent: SharedType<Id008Ptedo2zkLevel>,
    pub _self: SharedType<Self>,
    level: RefCell<i32>,
    level_position: RefCell<i32>,
    cycle: RefCell<i32>,
    cycle_position: RefCell<i32>,
    expected_commitment: RefCell<Id008Ptedo2zkLevel_Bool>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id008Ptedo2zkLevel {
    type Root = Id008Ptedo2zkLevel;
    type Parent = Id008Ptedo2zkLevel;
 ...
 */
impl Id008Ptedo2zkLevel {
    pub fn expected_commitment(&self) -> Ref<Id008Ptedo2zkLevel_Bool> {
...
pub enum Id008Ptedo2zkLevel_Bool {
    False,
    True,
    Unknown(i64),
}

impl TryFrom<i64> for Id008Ptedo2zkLevel_Bool {
    type Error = KError;
    fn try_from(flag: i64) -> KResult<Id008Ptedo2zkLevel_Bool> {
        match flag {
            0 => Ok(Id008Ptedo2zkLevel_Bool::False),
            255 => Ok(Id008Ptedo2zkLevel_Bool::True),
            _ => Ok(Id008Ptedo2zkLevel_Bool::Unknown(flag)),
        }
    }
}

impl From<&Id008Ptedo2zkLevel_Bool> for i64 {
    fn from(v: &Id008Ptedo2zkLevel_Bool) -> Self {
        match *v {
            Id008Ptedo2zkLevel_Bool::False => 0,
            Id008Ptedo2zkLevel_Bool::True => 255,
            Id008Ptedo2zkLevel_Bool::Unknown(v) => v
        }
    }
}

impl Default for Id008Ptedo2zkLevel_Bool {
    fn default() -> Self { Id008Ptedo2zkLevel_Bool::Unknown(0) }
}
