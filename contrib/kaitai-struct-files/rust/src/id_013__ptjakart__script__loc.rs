...
pub struct Id013PtjakartScriptLoc {
    pub _root: SharedType<Id013PtjakartScriptLoc>,
    pub _parent: SharedType<Id013PtjakartScriptLoc>,
    pub _self: SharedType<Self>,
    micheline__location: RefCell<i32>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id013PtjakartScriptLoc {
    type Root = Id013PtjakartScriptLoc;
    type Parent = Id013PtjakartScriptLoc;
