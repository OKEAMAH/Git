...
pub struct Id016PtmumbaiLevel {
    pub _root: SharedType<Id016PtmumbaiLevel>,
    pub _parent: SharedType<Id016PtmumbaiLevel>,
    pub _self: SharedType<Self>,
    level: RefCell<i32>,
    level_position: RefCell<i32>,
    cycle: RefCell<i32>,
    cycle_position: RefCell<i32>,
    expected_commitment: RefCell<Id016PtmumbaiLevel_Bool>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id016PtmumbaiLevel {
    type Root = Id016PtmumbaiLevel;
    type Parent = Id016PtmumbaiLevel;
 ...
 */
impl Id016PtmumbaiLevel {
    pub fn expected_commitment(&self) -> Ref<Id016PtmumbaiLevel_Bool> {
...
pub enum Id016PtmumbaiLevel_Bool {
    False,
    True,
    Unknown(i64),
}

impl TryFrom<i64> for Id016PtmumbaiLevel_Bool {
    type Error = KError;
    fn try_from(flag: i64) -> KResult<Id016PtmumbaiLevel_Bool> {
        match flag {
            0 => Ok(Id016PtmumbaiLevel_Bool::False),
            255 => Ok(Id016PtmumbaiLevel_Bool::True),
            _ => Ok(Id016PtmumbaiLevel_Bool::Unknown(flag)),
        }
    }
}

impl From<&Id016PtmumbaiLevel_Bool> for i64 {
    fn from(v: &Id016PtmumbaiLevel_Bool) -> Self {
        match *v {
            Id016PtmumbaiLevel_Bool::False => 0,
            Id016PtmumbaiLevel_Bool::True => 255,
            Id016PtmumbaiLevel_Bool::Unknown(v) => v
        }
    }
}

impl Default for Id016PtmumbaiLevel_Bool {
    fn default() -> Self { Id016PtmumbaiLevel_Bool::Unknown(0) }
}
