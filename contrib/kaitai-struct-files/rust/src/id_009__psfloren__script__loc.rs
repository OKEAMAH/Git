...
pub struct Id009PsflorenScriptLoc {
    pub _root: SharedType<Id009PsflorenScriptLoc>,
    pub _parent: SharedType<Id009PsflorenScriptLoc>,
    pub _self: SharedType<Self>,
    micheline__location: RefCell<i32>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id009PsflorenScriptLoc {
    type Root = Id009PsflorenScriptLoc;
    type Parent = Id009PsflorenScriptLoc;
