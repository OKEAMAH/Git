...
pub struct TimestampProtocol {
    pub _root: SharedType<TimestampProtocol>,
    pub _parent: SharedType<TimestampProtocol>,
    pub _self: SharedType<Self>,
    timestamp__protocol: RefCell<i64>,
    _io: RefCell<BytesReader>,
}
impl KStruct for TimestampProtocol {
    type Root = TimestampProtocol;
    type Parent = TimestampProtocol;
