...
pub struct Id010PtgranadConstants {
    pub _root: SharedType<Id010PtgranadConstants>,
    pub _parent: SharedType<Id010PtgranadConstants>,
    ...
    time_between_blocks: RefCell<OptRc<Id010PtgranadConstants_TimeBetweenBlocks>>,
    endorsers_per_block: RefCell<u16>,
    hard_gas_limit_per_operation: RefCell<OptRc<Id010PtgranadConstants_Z>>,
    hard_gas_limit_per_block: RefCell<OptRc<Id010PtgranadConstants_Z>>,
    proof_of_work_threshold: RefCell<i64>,
    tokens_per_roll: RefCell<OptRc<Id010PtgranadConstants_N>>,
    michelson_maximum_type_size: RefCell<u16>,
    seed_nonce_revelation_tip: RefCell<OptRc<Id010PtgranadConstants_N>>,
    origination_size: RefCell<i32>,
    block_security_deposit: RefCell<OptRc<Id010PtgranadConstants_N>>,
    endorsement_security_deposit: RefCell<OptRc<Id010PtgranadConstants_N>>,
    baking_reward_per_endorsement: RefCell<OptRc<Id010PtgranadConstants_BakingRewardPerEndorsement>>,
    endorsement_reward: RefCell<OptRc<Id010PtgranadConstants_EndorsementReward>>,
    cost_per_byte: RefCell<OptRc<Id010PtgranadConstants_N>>,
    hard_storage_limit_per_operation: RefCell<OptRc<Id010PtgranadConstants_Z>>,
    ...
    liquidity_baking_subsidy: RefCell<OptRc<Id010PtgranadConstants_N>>,
    liquidity_baking_sunset_level: RefCell<i32>,
    liquidity_baking_escape_ema_threshold: RefCell<i32>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id010PtgranadConstants {
    type Root = Id010PtgranadConstants;
    type Parent = Id010PtgranadConstants;
    ...
    fn read<S: KStream>(
        ...
        *self_rc.blocks_per_voting_period.borrow_mut() = _io.read_s4be()?.into();
        let t = Self::read_into::<_, Id010PtgranadConstants_TimeBetweenBlocks>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        *self_rc.time_between_blocks.borrow_mut() = t;
        *self_rc.endorsers_per_block.borrow_mut() = _io.read_u2be()?.into();
        let t = Self::read_into::<_, Id010PtgranadConstants_Z>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        ...
        *self_rc.proof_of_work_threshold.borrow_mut() = _io.read_s8be()?.into();
        let t = Self::read_into::<_, Id010PtgranadConstants_N>(&*_io, Some(self_rc._root.clone()), None)?.into();
        ...
        *self_rc.endorsement_security_deposit.borrow_mut() = t;
        let t = Self::read_into::<_, Id010PtgranadConstants_BakingRewardPerEndorsement>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
        *self_rc.baking_reward_per_endorsement.borrow_mut() = t;
        let t = Self::read_into::<_, Id010PtgranadConstants_EndorsementReward>(&*_io, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
...
impl Id010PtgranadConstants {
    pub fn time_between_blocks(&self) -> Ref<OptRc<Id010PtgranadConstants_TimeBetweenBlocks>> {
...
impl Id010PtgranadConstants {
    pub fn hard_gas_limit_per_operation(&self) -> Ref<OptRc<Id010PtgranadConstants_Z>> {
        self.hard_gas_limit_per_operation.borrow()
    }
}
impl Id010PtgranadConstants {
    pub fn hard_gas_limit_per_block(&self) -> Ref<OptRc<Id010PtgranadConstants_Z>> {
...
impl Id010PtgranadConstants {
    pub fn tokens_per_roll(&self) -> Ref<OptRc<Id010PtgranadConstants_N>> {
...
impl Id010PtgranadConstants {
    pub fn seed_nonce_revelation_tip(&self) -> Ref<OptRc<Id010PtgranadConstants_N>> {
...
impl Id010PtgranadConstants {
    pub fn block_security_deposit(&self) -> Ref<OptRc<Id010PtgranadConstants_N>> {
        self.block_security_deposit.borrow()
    }
}
impl Id010PtgranadConstants {
    pub fn endorsement_security_deposit(&self) -> Ref<OptRc<Id010PtgranadConstants_N>> {
        self.endorsement_security_deposit.borrow()
    }
}
impl Id010PtgranadConstants {
    pub fn baking_reward_per_endorsement(&self) -> Ref<OptRc<Id010PtgranadConstants_BakingRewardPerEndorsement>> {
        self.baking_reward_per_endorsement.borrow()
    }
}
impl Id010PtgranadConstants {
    pub fn endorsement_reward(&self) -> Ref<OptRc<Id010PtgranadConstants_EndorsementReward>> {
        self.endorsement_reward.borrow()
    }
}
impl Id010PtgranadConstants {
    pub fn cost_per_byte(&self) -> Ref<OptRc<Id010PtgranadConstants_N>> {
        self.cost_per_byte.borrow()
    }
}
impl Id010PtgranadConstants {
    pub fn hard_storage_limit_per_operation(&self) -> Ref<OptRc<Id010PtgranadConstants_Z>> {
...
impl Id010PtgranadConstants {
    pub fn liquidity_baking_subsidy(&self) -> Ref<OptRc<Id010PtgranadConstants_N>> {
...
#[derive(Default, Debug, Clone)]
pub struct Id010PtgranadConstants_TimeBetweenBlocksEntries {
    pub _root: SharedType<Id010PtgranadConstants>,
    pub _parent: SharedType<Id010PtgranadConstants_TimeBetweenBlocks>,
    pub _self: SharedType<Self>,
    time_between_blocks_elt: RefCell<i64>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id010PtgranadConstants_TimeBetweenBlocksEntries {
    type Root = Id010PtgranadConstants;
    type Parent = Id010PtgranadConstants_TimeBetweenBlocks;
...
impl Id010PtgranadConstants_TimeBetweenBlocksEntries {
}
impl Id010PtgranadConstants_TimeBetweenBlocksEntries {
...
#[derive(Default, Debug, Clone)]
pub struct Id010PtgranadConstants_N {
    pub _root: SharedType<Id010PtgranadConstants>,
    pub _parent: SharedType<KStructUnit>,
    pub _self: SharedType<Self>,
    n: RefCell<Vec<OptRc<Id010PtgranadConstants_NChunk>>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id010PtgranadConstants_N {
    type Root = Id010PtgranadConstants;
        ...
        *self_rc.n.borrow_mut() = Vec::new();
        {
            let mut _i = 0;
            while {
                let t = Self::read_into::<_, Id010PtgranadConstants_NChunk>(&*_io, Some(self_rc._root.clone()), None)?.into();
...
impl Id010PtgranadConstants_N {
}
impl Id010PtgranadConstants_N {
    pub fn n(&self) -> Ref<Vec<OptRc<Id010PtgranadConstants_NChunk>>> {
        self.n.borrow()
    }
}
impl Id010PtgranadConstants_N {
...
#[derive(Default, Debug, Clone)]
pub struct Id010PtgranadConstants_TimeBetweenBlocks {
    pub _root: SharedType<Id010PtgranadConstants>,
    pub _parent: SharedType<Id010PtgranadConstants>,
    pub _self: SharedType<Self>,
    len_time_between_blocks: RefCell<i32>,
    time_between_blocks: RefCell<Vec<OptRc<Id010PtgranadConstants_TimeBetweenBlocksEntries>>>,
    _io: RefCell<BytesReader>,
    time_between_blocks_raw: RefCell<Vec<Vec<u8>>>,
}
impl KStruct for Id010PtgranadConstants_TimeBetweenBlocks {
    type Root = Id010PtgranadConstants;
    type Parent = Id010PtgranadConstants;
        ...
        *self_rc.time_between_blocks.borrow_mut() = Vec::new();
        {
            ...
            while !_io.is_eof() {
                ...
                let t = Self::read_into::<BytesReader, Id010PtgranadConstants_TimeBetweenBlocksEntries>(&io_time_between_blocks_raw, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
...
impl Id010PtgranadConstants_TimeBetweenBlocks {
}
impl Id010PtgranadConstants_TimeBetweenBlocks {
...
impl Id010PtgranadConstants_TimeBetweenBlocks {
    pub fn time_between_blocks(&self) -> Ref<Vec<OptRc<Id010PtgranadConstants_TimeBetweenBlocksEntries>>> {
        self.time_between_blocks.borrow()
    }
}
impl Id010PtgranadConstants_TimeBetweenBlocks {
...
#[derive(Default, Debug, Clone)]
pub struct Id010PtgranadConstants_EndorsementReward {
    pub _root: SharedType<Id010PtgranadConstants>,
    pub _parent: SharedType<Id010PtgranadConstants>,
    pub _self: SharedType<Self>,
    len_endorsement_reward: RefCell<i32>,
    endorsement_reward: RefCell<Vec<OptRc<Id010PtgranadConstants_EndorsementRewardEntries>>>,
    _io: RefCell<BytesReader>,
    endorsement_reward_raw: RefCell<Vec<Vec<u8>>>,
}
impl KStruct for Id010PtgranadConstants_EndorsementReward {
    type Root = Id010PtgranadConstants;
    type Parent = Id010PtgranadConstants;
        ...
        *self_rc.endorsement_reward.borrow_mut() = Vec::new();
        {
            ...
            while !_io.is_eof() {
                ...
                let t = Self::read_into::<BytesReader, Id010PtgranadConstants_EndorsementRewardEntries>(&io_endorsement_reward_raw, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
...
impl Id010PtgranadConstants_EndorsementReward {
}
impl Id010PtgranadConstants_EndorsementReward {
...
impl Id010PtgranadConstants_EndorsementReward {
    pub fn endorsement_reward(&self) -> Ref<Vec<OptRc<Id010PtgranadConstants_EndorsementRewardEntries>>> {
        self.endorsement_reward.borrow()
    }
}
impl Id010PtgranadConstants_EndorsementReward {
...
#[derive(Default, Debug, Clone)]
pub struct Id010PtgranadConstants_EndorsementRewardEntries {
    pub _root: SharedType<Id010PtgranadConstants>,
    pub _parent: SharedType<Id010PtgranadConstants_EndorsementReward>,
    pub _self: SharedType<Self>,
    id_010__ptgranad__mutez: RefCell<OptRc<Id010PtgranadConstants_N>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id010PtgranadConstants_EndorsementRewardEntries {
    type Root = Id010PtgranadConstants;
    type Parent = Id010PtgranadConstants_EndorsementReward;
...
impl Id010PtgranadConstants_EndorsementRewardEntries {
}
impl Id010PtgranadConstants_EndorsementRewardEntries {
    pub fn id_010__ptgranad__mutez(&self) -> Ref<OptRc<Id010PtgranadConstants_N>> {
...
#[derive(Default, Debug, Clone)]
pub struct Id010PtgranadConstants_BakingRewardPerEndorsement {
    pub _root: SharedType<Id010PtgranadConstants>,
    pub _parent: SharedType<Id010PtgranadConstants>,
    pub _self: SharedType<Self>,
    len_baking_reward_per_endorsement: RefCell<i32>,
    baking_reward_per_endorsement: RefCell<Vec<OptRc<Id010PtgranadConstants_BakingRewardPerEndorsementEntries>>>,
    _io: RefCell<BytesReader>,
    baking_reward_per_endorsement_raw: RefCell<Vec<Vec<u8>>>,
}
impl KStruct for Id010PtgranadConstants_BakingRewardPerEndorsement {
    type Root = Id010PtgranadConstants;
    type Parent = Id010PtgranadConstants;
        ...
        *self_rc.baking_reward_per_endorsement.borrow_mut() = Vec::new();
        {
            ...
            while !_io.is_eof() {
                ...
                let t = Self::read_into::<BytesReader, Id010PtgranadConstants_BakingRewardPerEndorsementEntries>(&io_baking_reward_per_endorsement_raw, Some(self_rc._root.clone()), Some(self_rc._self.clone()))?.into();
...
impl Id010PtgranadConstants_BakingRewardPerEndorsement {
}
impl Id010PtgranadConstants_BakingRewardPerEndorsement {
...
impl Id010PtgranadConstants_BakingRewardPerEndorsement {
    pub fn baking_reward_per_endorsement(&self) -> Ref<Vec<OptRc<Id010PtgranadConstants_BakingRewardPerEndorsementEntries>>> {
        self.baking_reward_per_endorsement.borrow()
    }
}
impl Id010PtgranadConstants_BakingRewardPerEndorsement {
...
#[derive(Default, Debug, Clone)]
pub struct Id010PtgranadConstants_NChunk {
    pub _root: SharedType<Id010PtgranadConstants>,
    pub _parent: SharedType<KStructUnit>,
    pub _self: SharedType<Self>,
...
impl KStruct for Id010PtgranadConstants_NChunk {
    type Root = Id010PtgranadConstants;
    type Parent = KStructUnit;
...
impl Id010PtgranadConstants_NChunk {
}
impl Id010PtgranadConstants_NChunk {
...
#[derive(Default, Debug, Clone)]
pub struct Id010PtgranadConstants_Z {
    pub _root: SharedType<Id010PtgranadConstants>,
    pub _parent: SharedType<Id010PtgranadConstants>,
    pub _self: SharedType<Self>,
    ...
    sign: RefCell<bool>,
    payload: RefCell<u64>,
    tail: RefCell<Vec<OptRc<Id010PtgranadConstants_NChunk>>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id010PtgranadConstants_Z {
    type Root = Id010PtgranadConstants;
    type Parent = Id010PtgranadConstants;
...
impl Id010PtgranadConstants_Z {
    pub fn tail(&self) -> Ref<Vec<OptRc<Id010PtgranadConstants_NChunk>>> {
        self.tail.borrow()
    }
}
impl Id010PtgranadConstants_Z {
...
#[derive(Default, Debug, Clone)]
pub struct Id010PtgranadConstants_BakingRewardPerEndorsementEntries {
    pub _root: SharedType<Id010PtgranadConstants>,
    pub _parent: SharedType<Id010PtgranadConstants_BakingRewardPerEndorsement>,
    pub _self: SharedType<Self>,
    id_010__ptgranad__mutez: RefCell<OptRc<Id010PtgranadConstants_N>>,
    _io: RefCell<BytesReader>,
}
impl KStruct for Id010PtgranadConstants_BakingRewardPerEndorsementEntries {
    type Root = Id010PtgranadConstants;
    type Parent = Id010PtgranadConstants_BakingRewardPerEndorsement;
...
impl Id010PtgranadConstants_BakingRewardPerEndorsementEntries {
}
impl Id010PtgranadConstants_BakingRewardPerEndorsementEntries {
    pub fn id_010__ptgranad__mutez(&self) -> Ref<OptRc<Id010PtgranadConstants_N>> {
        self.id_010__ptgranad__mutez.borrow()
