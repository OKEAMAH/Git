...
types:
  alpha__operation__alpha__contents_and_signature_:
    seq:
...
- id: operation__shell_header
  size: 32
  doc: An operation's shell header.
- id: alpha__operation__alpha__contents_and_signature_
  type: alpha__operation__alpha__contents_and_signature_
