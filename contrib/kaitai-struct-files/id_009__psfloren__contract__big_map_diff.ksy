...
types:
  ...
  copy__id_009__psfloren__contract__big_map_diff_elt:
    ...
    - id: destination_big_map
      type: z
  id_009__psfloren__contract__big_map_diff_dyn:
    seq:
...
enums:
  ...
  id_009__psfloren__contract__big_map_diff_elt_tag:
    ...
    3: alloc
seq:
- id: len_id_009__psfloren__contract__big_map_diff_dyn
  type: u4
  valid:
    max: 1073741823
- id: id_009__psfloren__contract__big_map_diff_dyn
  type: id_009__psfloren__contract__big_map_diff_dyn
  size: len_id_009__psfloren__contract__big_map_diff_dyn
