...
types:
  id_018__proxford__operation_metadata__alpha__balance_updates:
    seq:
    - id: size_of_id_018__proxford__operation_metadata__alpha__balance_updates
      type: u4
      valid:
        max: 1073741823
    - id: id_018__proxford__operation_metadata__alpha__balance_updates
      ...
      size: size_of_id_018__proxford__operation_metadata__alpha__balance_updates
      repeat: eos
  ...
  unstaked_deposits__id_018__proxford__operation_metadata__alpha__balance:
    seq:
    - id: staker
      type: unstaked_deposits__id_018__proxford__staker
      doc: ! >-
    ...
    - id: cycle
      type: s4
  unstaked_deposits__id_018__proxford__staker:
    seq:
  ...
  unstaked_deposits__single__id_018__proxford__staker:
    seq:
    - id: contract
      type: unstaked_deposits__single__id_018__proxford__contract_id
      doc: ! >-
  ...
  unstaked_deposits__single__public_key_hash:
    ...
    - id: unstaked_deposits__single__bls__public_key_hash
      size: 20
      if: (public_key_hash_tag == ::public_key_hash_tag::public_key_hash_tag::bls)
  unstaked_deposits__single__id_018__proxford__contract_id:
    seq:
  ...
  frozen_bonds__id_018__proxford__operation_metadata__alpha__balance:
    seq:
    - id: contract
      type: frozen_bonds__id_018__proxford__contract_id
      doc: ! >-
        A contract handle: A contract notation as given to an RPC or inside scripts.
        Can be a base58 implicit contract hash or a base58 originated contract hash.
    - id: bond_id
      type: frozen_bonds__id_018__proxford__bond_id
  frozen_bonds__id_018__proxford__bond_id:
    seq:
    ...
    - id: frozen_bonds__smart_rollup_bond_id__id_018__proxford__bond_id
      size: 20
      if: (id_018__proxford__bond_id_tag == ::id_018__proxford__bond_id_tag::id_018__proxford__bond_id_tag::smart_rollup_bond_id)
  frozen_bonds__id_018__proxford__contract_id:
    seq:
    - id: id_018__proxford__contract_id_tag
      type: u1
      enum: id_018__proxford__contract_id_tag
  ...
  lost_attesting_rewards__public_key_hash:
    ...
    - id: lost_attesting_rewards__bls__public_key_hash
      size: 20
      if: (public_key_hash_tag == ::public_key_hash_tag::public_key_hash_tag::bls)
  deposits__id_018__proxford__staker:
    seq:
    - id: id_018__proxford__staker_tag
      type: u1
      enum: id_018__proxford__staker_tag
  ...
  deposits__single__id_018__proxford__staker:
    seq:
    - id: contract
      type: deposits__single__id_018__proxford__contract_id
      doc: ! >-
        A contract handle: A contract notation as given to an RPC or inside scripts.
        Can be a base58 implicit contract hash or a base58 originated contract hash.
    - id: delegate
  ...
  deposits__single__public_key_hash:
    ...
    - id: deposits__single__bls__public_key_hash
      size: 20
      if: (public_key_hash_tag == ::public_key_hash_tag::public_key_hash_tag::bls)
  deposits__single__id_018__proxford__contract_id:
    seq:
    - id: id_018__proxford__contract_id_tag
      type: u1
      enum: id_018__proxford__contract_id_tag
  ...
  deposits__single__implicit__public_key_hash:
    ...
    - id: deposits__single__implicit__bls__public_key_hash
      size: 20
      if: (public_key_hash_tag == ::public_key_hash_tag::public_key_hash_tag::bls)
  contract__id_018__proxford__contract_id:
    seq:
    - id: id_018__proxford__contract_id_tag
      type: u1
      enum: id_018__proxford__contract_id_tag
