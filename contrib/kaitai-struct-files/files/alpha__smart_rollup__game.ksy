...
types:
  ...
  content_0:
    ...
    - id: content_tag
      type: u1
      enum: content_tag
    - id: no_attestations_for_level
      type: no_attestations_for_level
      if: (content_tag == content_tag::no_attestations_for_level)
    - id: attested
      type: attested
  ...
  dal_snapshot:
    ...
    - id: dal_skip_list_v2
      type: skip_list
      if: (dal_snapshot_tag == dal_snapshot_tag::dal_skip_list_v2)
  dissecting:
    seq:
    - id: dissection
      type: dissection_0
