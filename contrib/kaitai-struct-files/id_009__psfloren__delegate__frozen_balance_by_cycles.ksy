...
types:
  id_009__psfloren__delegate__frozen_balance_by_cycles_dyn:
    seq:
  ...
  n_chunk:
    ...
    - id: payload
      type: b7be
seq:
- id: len_id_009__psfloren__delegate__frozen_balance_by_cycles_dyn
  type: u4
  valid:
    max: 1073741823
- id: id_009__psfloren__delegate__frozen_balance_by_cycles_dyn
  type: id_009__psfloren__delegate__frozen_balance_by_cycles_dyn
  size: len_id_009__psfloren__delegate__frozen_balance_by_cycles_dyn
