...
types:
  id_006__pscartha__block_header__alpha__full_header_:
    seq:
    ...
    - id: id_006__pscartha__block_header__alpha__signed_contents_
      type: id_006__pscartha__block_header__alpha__signed_contents_
  id_006__pscartha__block_header__alpha__signed_contents_:
    seq:
    - id: id_006__pscartha__block_header__alpha__unsigned_contents_
      type: id_006__pscartha__block_header__alpha__unsigned_contents_
    - id: signature
      size: 64
  id_006__pscartha__block_header__alpha__unsigned_contents_:
    seq:
    - id: priority
      type: u2
...
enums:
  bool:
    ...
    255: true
seq:
- id: id_006__pscartha__block_header__alpha__full_header_
  type: id_006__pscartha__block_header__alpha__full_header_
