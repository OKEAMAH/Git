...
types:
  id_006__pscartha__operation_metadata__alpha__balance_updates_:
    seq:
    - id: len_id_006__pscartha__operation_metadata__alpha__balance_updates_dyn
      type: uint30
    - id: id_006__pscartha__operation_metadata__alpha__balance_updates_dyn
      type: id_006__pscartha__operation_metadata__alpha__balance_updates_dyn
      size: len_id_006__pscartha__operation_metadata__alpha__balance_updates_dyn
  id_006__pscartha__operation_metadata__alpha__balance_updates_dyn:
    seq:
  ...
  id_006__pscartha__operation_metadata__alpha__balance_updates_entries:
    seq:
    - id: id_006__pscartha__operation_metadata__alpha__balance_
      type: id_006__pscartha__operation_metadata__alpha__balance_
    - id: id_006__pscartha__operation_metadata__alpha__balance_update
      type: s8
  id_006__pscartha__operation_metadata__alpha__balance_:
    seq:
    ...
    - id: contract__id_006__pscartha__operation_metadata__alpha__balance
      type: contract__id_006__pscartha__contract_id_
  ...
  rewards__public_key_hash_:
    ...
    - id: rewards__p256__public_key_hash
      size: 20
      if: (public_key_hash_tag == public_key_hash_tag::p256)
  contract__id_006__pscartha__contract_id_:
    seq:
...
enums:
  ...
  id_006__pscartha__operation_metadata__alpha__balance_tag:
    ...
    3: deposits
seq:
- id: id_006__pscartha__operation_metadata__alpha__balance_updates_
