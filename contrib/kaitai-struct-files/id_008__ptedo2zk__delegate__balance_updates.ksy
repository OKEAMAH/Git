...
types:
  contract__id_008__ptedo2zk__contract_id_:
    seq:
  ...
  fees__public_key_hash_:
    ...
    - id: fees__p256__public_key_hash
      size: 20
      if: (public_key_hash_tag == public_key_hash_tag::p256)
  id_008__ptedo2zk__operation_metadata__alpha__balance_:
    seq:
    ...
    - id: contract__id_008__ptedo2zk__operation_metadata__alpha__balance
      type: contract__id_008__ptedo2zk__contract_id_
  ...
  id_008__ptedo2zk__operation_metadata__alpha__balance_updates_:
    seq:
    - id: len_id_008__ptedo2zk__operation_metadata__alpha__balance_updates_dyn
      type: u4
      valid:
        max: 1073741823
    - id: id_008__ptedo2zk__operation_metadata__alpha__balance_updates_dyn
      type: id_008__ptedo2zk__operation_metadata__alpha__balance_updates_dyn
      size: len_id_008__ptedo2zk__operation_metadata__alpha__balance_updates_dyn
  id_008__ptedo2zk__operation_metadata__alpha__balance_updates_dyn:
    seq:
  ...
  id_008__ptedo2zk__operation_metadata__alpha__balance_updates_entries:
    seq:
    - id: id_008__ptedo2zk__operation_metadata__alpha__balance_
      type: id_008__ptedo2zk__operation_metadata__alpha__balance_
...
enums:
  ...
  id_008__ptedo2zk__operation_metadata__alpha__balance_tag:
    ...
    3: deposits
seq:
- id: id_008__ptedo2zk__operation_metadata__alpha__balance_updates_
