...
types:
  ...
  id_015__ptlimapt__operation_metadata__alpha__balance:
    ...
    - id: contract__id_015__ptlimapt__operation_metadata__alpha__balance
      type: contract__id_015__ptlimapt__contract_id
      if: (id_015__ptlimapt__operation_metadata__alpha__balance_tag == ::id_015__ptlimapt__operation_metadata__alpha__balance_tag::id_015__ptlimapt__operation_metadata__alpha__balance_tag::contract)
      doc: ! >-
        A contract handle: A contract notation as given to an RPC or inside scripts.
        Can be a base58 implicit contract hash or a base58 originated contract hash.
    - id: deposits__id_015__ptlimapt__operation_metadata__alpha__balance
      type: deposits__public_key_hash
      if: (id_015__ptlimapt__operation_metadata__alpha__balance_tag == ::id_015__ptlimapt__operation_metadata__alpha__balance_tag::id_015__ptlimapt__operation_metadata__alpha__balance_tag::deposits)
      doc: A Ed25519, Secp256k1, or P256 public key hash
    - id: lost_endorsing_rewards__id_015__ptlimapt__operation_metadata__alpha__balance
      type: lost_endorsing_rewards__id_015__ptlimapt__operation_metadata__alpha__balance
  ...
  frozen_bonds__id_015__ptlimapt__bond_id:
    ...
    - id: frozen_bonds__tx_rollup_bond_id__id_015__ptlimapt__bond_id
      size: 20
      if: (id_015__ptlimapt__bond_id_tag == ::id_015__ptlimapt__bond_id_tag::id_015__ptlimapt__bond_id_tag::tx_rollup_bond_id)
      doc: ! >-
