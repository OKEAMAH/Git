...
types:
  ...
  id_015__ptlimapt__operation_metadata__alpha__balance_updates_dyn:
    seq:
  ...
  id_015__ptlimapt__operation_metadata__alpha__balance_updates_entries:
    seq:
    - id: id_015__ptlimapt__operation_metadata__alpha__balance_
      type: id_015__ptlimapt__operation_metadata__alpha__balance_
    ...
    - id: id_015__ptlimapt__operation_metadata__alpha__update_origin
      type: u1
      enum: origin_tag
  id_015__ptlimapt__operation_metadata__alpha__balance_:
    seq:
    ...
    - id: contract__id_015__ptlimapt__operation_metadata__alpha__balance
      type: contract__id_015__ptlimapt__contract_id_
  ...
  frozen_bonds__id_015__ptlimapt__operation_metadata__alpha__balance:
    seq:
    - id: contract
      type: frozen_bonds__id_015__ptlimapt__contract_id_
      doc: ! >-
        A contract handle: A contract notation as given to an RPC or inside scripts.
        Can be a base58 implicit contract hash or a base58 originated contract hash.
    - id: bond_id
      type: frozen_bonds__id_015__ptlimapt__bond_id_
  frozen_bonds__id_015__ptlimapt__bond_id_:
    seq:
  ...
  deposits__public_key_hash_:
    ...
    - id: deposits__p256__public_key_hash
      size: 20
      if: (public_key_hash_tag == public_key_hash_tag::p256)
  contract__id_015__ptlimapt__contract_id_:
    seq:
    - id: id_015__ptlimapt__contract_id_tag
      type: u1
      enum: id_015__ptlimapt__contract_id_tag
...
seq:
- id: id_015__ptlimapt__operation_metadata__alpha__balance_updates_
