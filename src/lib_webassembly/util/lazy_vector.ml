...
module Immutable = struct
  ...
  module Make (Effect : Effect.S) (Key : KeyS) :
    ...
    let grow ?produce_value delta map =
      if
        Key.unsigned_compare (Key.add delta map.num_elements) map.num_elements
        < 0
...
module Mutable = struct
  ...
  module IntVector = Make (Immutable.IntVector)
  module Int32Vector = Make (Immutable.Int32Vector)
  module Int64Vector = Make (Immutable.Int64Vector)
  module LwtIntVector = Make (Immutable.LwtIntVector)
  module LwtInt32Vector = Make (Immutable.LwtInt32Vector)
  module LwtInt64Vector = Make (Immutable.LwtInt64Vector)
  module LwtZVector = Make (Immutable.LwtZVector)
end
