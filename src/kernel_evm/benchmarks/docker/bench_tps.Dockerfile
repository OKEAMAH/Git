# FOR IT TO WORK
# - needs debugger with no debug
# - needs scenario with 3000+ erc20 transfers
...
COPY --chown=node:nogroup inbox_200tps.json ressources/
COPY --chown=node:nogroup inbox_200tps_nolevel.json ressources/
