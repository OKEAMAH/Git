...
const SETUP_FILE_PATH = external.ressource('src/kernel_evm/config/benchmarking.yaml')
const EVM_KERNEL_PATH = external.ressource('src/kernel_evm/target/wasm32-unknown-unknown/release/evm_kernel.wasm')
