...
module Make (Elt : Elt_sig) : Carray_sig with type elt = Elt.t = struct
  ...
  module Stubs = struct
    external get : elt -> t -> int -> int -> unit
      = "caml_bls12_381_polynomial_internal_carray_get_stubs"
      [@@noalloc]
    ...
    external set : t -> elt -> int -> int -> unit
      = "caml_bls12_381_polynomial_internal_carray_set_stubs"
      [@@noalloc]
    ...
    external memset_zero : t -> int -> unit
      = "caml_bls12_381_polynomial_internal_memset_zero_stubs"
      [@@noalloc]
