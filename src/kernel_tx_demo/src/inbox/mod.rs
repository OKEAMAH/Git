...
mod test {
    ...
    fn test_encode_decode_internal_transfer() {
        ...
        let expected_bytes = vec![
            ...
            b'$', b'f', b'g', 169, b'1', 254, 11, 210, 251, 28, 182, 4, 247, 20, b'`', 30,
            136, b'(', b'E', b'P', // end kt1
            // Source tz1RjtZUVeLhADFHDL8UwDZA6vjWWhojpu5w
            0, // PKH - Ed25519 tag
            b'B', 236, b'v', b'_', b'\'', 0, 19, b'N', 158, 14, 254, 137, 208, b'3', 142,
            b'.', 132, b'<', b'S', 220, // end tz1
        ...
        let ticket =
            StringTicket::new(ticket_creator, MichelsonString("red".to_string()), 1)
                .unwrap();
    ...
    fn assert_encode_decode_inbox_message(
        ...
        let decoded =
            InboxMessage::<MichelsonPair<MichelsonString, StringTicket>>::parse(
                encoded.as_slice(),
            )
