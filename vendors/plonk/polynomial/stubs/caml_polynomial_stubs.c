...
static void finalize_blst_fr_array(value v) {
  free(Blst_fr_array_val(v));
}
...
CAMLprim value caml_compute_domain_stubs(value buffer, value n,
                                         value root_of_unity) {
...
CAMLprim value caml_of_fr_array_truncated_stubs(value buffer, value vs, value n, value k) {
  CAMLparam4(buffer, vs, n, k);

  blst_fr *vs_c = Blst_fr_array_val(vs);
  int buffer_size = Int_val(k);
  for (int i = 0; i < buffer_size; i++) {
    memcpy(Fr_val_k(buffer, i), vs_c + i, sizeof(blst_fr));
  }
  CAMLreturn(Val_unit);
...
CAMLprim value caml_degree_stubs(value arg, value n) {
  CAMLparam2(arg, n);

  blst_fr *arg_c = Blst_fr_array_val(arg);
  int n_c = Int_val(n);
  int res = degree(arg_c, n_c);
  CAMLreturn(Val_int(res));
}

CAMLprim value caml_get_stubs(value res, value arg, value idx) {
...
CAMLprim value caml_copy_stubs(value buffer, value vs, value n) {
  CAMLparam3(buffer, vs, n);
...
CAMLprim value caml_fft_inplace_on_stubs(value coefficients, value domain,
  ...
  fft_inplace(coefficients_c, domain_c, log_domain_size_c);
  CAMLreturn(Val_unit);
}

CAMLprim value caml_ifft_inplace_on_stubs(value coefficients, value domain,
                                          value log_domain_size) {
  CAMLparam3(coefficients, domain, log_domain_size);
  ...
  blst_fr *domain_c = Blst_fr_array_val(domain);
  blst_fr *coefficients_c = Blst_fr_array_val(coefficients);
  ifft_inplace(coefficients_c, domain_c, log_domain_size_c);
  CAMLreturn(Val_unit);
}
...
CAMLprim value caml_polynomial_eq_stubs(value polynomial_1, value polynomial_2,
  ...
  bool is_equal = eq(poly_1_c, poly_2_c, size_1_c, size_2_c);
...
CAMLprim value caml_polynomial_add_stubs(value res, value arg_1, value arg_2,
  ...
  add(res_c, arg_1_c, arg_2_c, size_1_c, size_2_c);
  CAMLreturn(Val_unit);
}
...
CAMLprim value caml_polynomial_sub_stubs(value res, value arg_1, value arg_2,
  ...
  sub(res_c, arg_1_c, arg_2_c, size_1_c, size_2_c);
  CAMLreturn(Val_unit);
}
...
CAMLprim value caml_polynomial_mul_stubs(value res, value arg_1, value arg_2,
  ...
  mul(res_c, arg_1_c, arg_2_c, size_1_c, size_2_c);
  CAMLreturn(Val_unit);
}
...
CAMLprim value caml_polynomial_mul_by_scalar_stubs(value res, value scalar,
  ...
  mul_by_scalar(res_c, scalar_c, arg_c, size_c);
  CAMLreturn(Val_unit);
}
...
CAMLprim value caml_polynomial_evaluate_stubs(value res, value arg, value size,
  ...
  evaluate(res_c, arg_c, size_c, scalar_c);
  CAMLreturn(Val_unit);
}
...
CAMLprim value caml_polynomial_is_zero_stubs(value poly, value size) {
  ...
  int size_c = Int_val(size);
  bool res = is_zero(poly_c, size_c);
...
CAMLprim value caml_polynomial_division_x_z_stubs(value res, value poly,
  ...
  division_x_z(res_c, poly_c, size_c, z_c);
  CAMLreturn(Val_unit);
}
...
CAMLprim value caml_polynomial_division_zs_stubs(value res, value poly,
  ...
  int size_c = Int_val(size);
  int n_c = Int_val(n);
  division_zs(res_c, poly_c, size_c, n_c);
  CAMLreturn(Val_unit);
}
...
CAMLprim value caml_polynomial_mul_zs_stubs(value res, value poly, value size,
  ...
  int size_c = Int_val(size);
  int n_c = Int_val(n);
  mul_zs(res_c, poly_c, size_c, n_c);
  CAMLreturn(Val_unit);
}

// Bindings for evaluations.ml

CAMLprim value caml_evaluations_add_stubs(value res, value eval_1, value eval_2,
                                          value size_1, value size_2) {
  ...
  evaluations_add(res_c, eval_1_c, eval_2_c, size_1_c, size_2_c);
  CAMLreturn(Val_unit);
}

CAMLprim value caml_evaluations_rescale_stubs(value res, value eval,
                                              value size_res, value size_eval) {
  ...
  evaluations_rescale(res_c, eval_c, size_res_c, size_eval_c);
  CAMLreturn(Val_unit);
}

CAMLprim value caml_evaluations_mul_arrays_stubs(
  ...
  evaluations_mul_arrays(res_c, evaluations_c, evaluations_len_c,
                         composition_gx_c, powers_c, powers_len_c, size_res_c,
                         nb_evals_c);
  CAMLreturn(Val_unit);
}

CAMLprim value caml_evaluations_linear_arrays_stubs(
  ...
  evaluations_linear_arrays(res_c, evaluations_c, evaluations_len_c,
                            linear_coeffs_c, composition_gx_c, add_constant_c,
                            size_res_c, nb_evals_c);
  CAMLreturn(Val_unit);
}

CAMLprim value caml_polynomial_derivative_stubs(value res, value poly, value size) {
  CAMLparam3(res, poly, size);
  blst_fr *poly_c = Blst_fr_array_val(poly);
  blst_fr *res_c = Blst_fr_array_val(res);
  int size_c = Int_val(size);
  derivative(res_c, poly_c, size_c);
  CAMLreturn(Val_unit);
}

CAMLprim value caml_polynomial_truncate_inplace_stubs(value poly, value k, value size) {
  CAMLparam3(poly, k, size);
  blst_fr *poly_c = Blst_fr_array_val(poly);
  int k_c = Int_val(k);
  int size_c = Int_val(size);
  truncate_inplace(poly_c, k_c, size_c);
  CAMLreturn(Val_unit);
}

CAMLprim value caml_polynomial_negate_truncated_inplace_stubs(value poly, value k, value size) {
  CAMLparam3(poly, k, size);
  blst_fr *poly_c = Blst_fr_array_val(poly);
  int k_c = Int_val(k);
  int size_c = Int_val(size);
  negate_truncated_inplace(poly_c, k_c, size_c);
  CAMLreturn(Val_unit);
}
