...
module Stubs = struct
  ...
  external truncate_inplace : fr_array -> int -> int -> unit
    = "caml_polynomial_truncate_inplace_stubs"
    [@@noalloc]

  external opposite_truncated_inplace : fr_array -> int -> int -> unit
    = "caml_polynomial_negate_truncated_inplace_stubs"
    [@@noalloc]
end
...
module Polynomial_impl = struct
  ...
  let to_array_truncated : t -> int -> scalar array =
   fun x i -> Carray.to_array_truncated x i
  ...
  let opposite_truncated_inplace (poly, size) k =
    Stubs.opposite_truncated_inplace poly size k
  ...
  let truncate_inplace (poly, size) k = Stubs.truncate_inplace poly k size
 ...
 *)
  ...
  val to_array_truncated : t -> int -> scalar array
  ...
  val opposite_truncated_inplace : t -> int -> unit
  ...
  val truncate_inplace : t -> int -> unit
