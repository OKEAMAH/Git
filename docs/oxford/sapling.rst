...
``protocols/proto_018_Proxford/lib_protocol/test/integration/michelson/contracts/sapling_contract.tz``.
...
::
   ...
   running protocols/proto_018_Proxford/lib_protocol/test/integration/michelson/contracts/sapling_contract.tz \
   --init '{ }' --burn-cap 3 &
