...
the :ref:`concrete syntax <ConcreteSyntax_jarlsberg>`. In particular
...
.. _michelson_type_system_jarlsberg:
...
-  ``big_map (k) (t)``: Lazily deserialized maps from keys of type
   ...
   See the section on :ref:`operations on big maps <OperationsOnBigMaps_jarlsberg>` for a description of the syntax of values of type ``big_map (k) (t)`` and available operations.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~
.. _OperationsOnBigMaps_jarlsberg:
...
.. _MichelsonSetDelegate_jarlsberg:
...
:ref:`special annotations <SpecialAnnotations_jarlsberg>` and are not allowed everywhere.
...
The multisig commands of :ref:`Tezos command line client <client_manual_jarlsberg>`
use this
