...
The :ref:`randomness<random_seed_jarlsberg>` is obtained from information already found on the
...
:ref:`protocol constant <protocol_constants_jarlsberg>`.
...
The seed of the PRNG is the :ref:`random seed <random_seed_jarlsberg>` associated with cycle ``n-PRESERVED_CYCLES``.
