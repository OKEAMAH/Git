...
the :ref:`concrete syntax <ConcreteSyntax_kashkaval>`. In particular
...
.. _michelson_type_system_kashkaval:
...
-  ``big_map (k) (t)``: Lazily deserialized maps from keys of type
   ...
   See the section on :ref:`operations on big maps <OperationsOnBigMaps_kashkaval>` for a description of the syntax of values of type ``big_map (k) (t)`` and available operations.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~
.. _OperationsOnBigMaps_kashkaval:
...
.. _MichelsonSetDelegate_kashkaval:
...
:ref:`special annotations <SpecialAnnotations_kashkaval>` and are not allowed everywhere.
...
The multisig commands of :ref:`Tezos command line client <client_manual_kashkaval>`
use this
