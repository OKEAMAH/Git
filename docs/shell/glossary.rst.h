...
_`Fitness` (a.k.a. score, weight)
    For each block, the consensus algotrithm can compute a score called fitness (see :ref:`details <fitness_implem>`) which determines the quality of the chain leading to that block.
